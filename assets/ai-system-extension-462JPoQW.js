import{c as H,w as ot,e as $e,g as P,i as _,n as y,G as U,b as c,H as v,o as lt,t as R,I as ct,h as te,r as k,L as He,q as B,k as ie,J as pt,u as dt,A as ht,a as ut,s as we,z as Fe,f as gt,S as mt,T as Oe,m as ft,l as wt,K as bt}from"./main-EmQVFKnb.js";import{C as be,a as vt,P as Ze,K as j,b as W,T as Ve,E as kt,c as yt,t as me,d as xt}from"./ai-service-C_8dZGXN.js";const $t=`You are an assistant in a web application with workspace, editors, and AI chat.
...
Please report this to https://github.com/markedjs/marked.`,t){let a="<p>An error occurred:</p><pre>"+M(r.message+"",!0)+"</pre>";return e?Promise.resolve(a):a}if(e)return Promise.reject(r);throw r}}},D=new hs;function w(t,e){return D.parse(t,e)}w.options=w.setOptions=function(t){return D.setOptions(t),w.defaults=D.defaults,Ke(w.defaults),w};w.getDefaults=Se;w.defaults=L;w.use=function(...t){return D.use(...t),w.defaults=D.defaults,Ke(w.defaults),w};w.walkTokens=function(t,e){return D.walkTokens(t,e)};w.parseInline=D.parseInline;w.Parser=C;w.parser=C.parse;w.Renderer=ce;w.TextRenderer=Re;w.Lexer=T;w.lexer=T.lex;w.Tokenizer=le;w.Hooks=Q;w.parse=w;w.options;w.setOptions;w.use;w.walkTokens;w.parseInline;C.parse;T.lex;var us=Object.defineProperty,gs=Object.getOwnPropertyDescriptor,re=(t,e,r,a)=>{for(var s=a>1?void 0:a?gs(e,r):e,n=t.length-1,i;n>=0;n--)(i=t[n])&&(s=(a?i(e,r,s):i(s))||s);return a&&s&&us(e,r,s),s};let O=class extends U{constructor(){super(...arguments),this.isStreaming=!1,this.showHeader=!0}updated(t){super.updated(t),(t.has("message")||!this.hasAttribute("data-is-user"))&&this.updateAlignment()}updateAlignment(){this.message&&this.setAttribute("data-is-user",String(this.message.role==="user"))}copyToClipboard(t){navigator.clipboard.writeText(t).catch(e=>console.error("Failed to copy:",e))}processMarkdownContent(t){return t.includes("code-blocwrapper")?t:t.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,r,a)=>`
    ...
    `;z([y({attribute:!1})],S.prototype,"input",2);z([k()],S.prototype,"providers",2);z([k()],S.prototype,"defaultProvider",2);z([k()],S.prototype,"hasChanges",2);z([k()],S.prototype,"availableModels",2);z([k()],S.prototype,"loadingModels",2);z([k()],S.prototype,"requireToolApproval",2);z([k()],S.prototype,"smartToolDetection",2);z([k()],S.prototype,"editingState",2);S=z([R("lyra-ai-config-editor")],S);H.registerContribution(mt,{name:"aiview",label:"AI Assistant",icon:"robot",component:t=>c`<lyra-aiview id="${t}"></lyra-aiview>`});H.registerContribution(xt,{label:"App Support",description:"General-purpose assistant that can answer questions and execute app commands",role:"appsupport",priority:100,icon:"question-circle",sysPrompt:$t,tools:async()=>({enabled:!0,smartToolDetection:(await P.get(j))?.smartToolDetection??!1})});H.registerContribution(Oe,{target:Oe,label:"Token Usage",component:"<lyra-token-usage></lyra-token-usage>"});$e.registerEditorInputHandler({editorId:"system.ai-config-editor",label:"AI Config",ranking:1e3,canHandle:t=>t.key===".system.ai-config",handle:async t=>(t.component=()=>c`<lyra-ai-config-editor .input="${t}"></lyra-ai-config-editor>`,t)});ft({command:{id:"open_ai_config",name:"Open AI Configuration",description:"Open the AI system configuration editor",parameters:[]},handler:{execute:t=>{const e={title:"AI Settings",data:{},key:".system.ai-config",icon:"robot",state:{}};$e.loadEditor(e).then()}},contribution:{target:wt,icon:"robot",label:"AI Config"}});bt.put("aiService",W);
