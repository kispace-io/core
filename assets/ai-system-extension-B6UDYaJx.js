const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-e2lcKaqt.js","assets/main-BYaEr26l.css"])))=>i.map(i=>d[i]);
import{l as E,ac as m,Q as Ae,w as le,f as X,L as ce,i as $,n as v,g as w,ad as U,x as l,ae as h,o as Ee,k as Se,h as P,af as ye,C as Y,_ as F,u as I,K as ie,G as K,a1 as de,t as L,j as M,c as pe,aD as he,y as J,H as ge,s as Q,aF as Te,aG as Z,aH as Ce,q as ue,a2 as ee,S as me,ap as ve,aI as Oe,N as te,b as we,T as fe,r as be,ag as _e,ah as Ie,a9 as $e,ai as Pe,e as Me,F as xe,aj as ke,ak as Re,al as Ne,am as De,a3 as Le,an as Ue,ao as Ge,aq as ze,ar as qe,as as Ve,a5 as Ke,R as Fe,M as We,X as Be,P as je,Y as He,at as Ye,J as Qe,au as Xe,W as Je,av as Ze,a0 as et,aw as tt,E as at,ax as st,ay as it,az as ot,D as rt,aA as nt,$ as lt,aB as ct,v as dt,O as pt,d as ht,a8 as gt,aC as ut,aE as mt,Z as vt}from"./main-e2lcKaqt.js";const ne=Object.freeze(Object.defineProperty({__proto__:null,COMMAND_SAVE:_e,CommandRegistry:Ie,Directory:$e,EDITOR_AREA_MAIN:Pe,File:Me,FileContentType:xe,HIDE_DOT_RESOURCE:ke,KContainer:Re,KDialogContent:Ne,KElement:ge,KPart:ie,get KStandardApp(){return De},KWidget:Le,MouseButton:Ue,PANEL_BOTTOM:Ge,SIDEBAR_AUXILIARY:ve,SIDEBAR_MAIN:ze,SIDEBAR_MAIN_BOTTOM:qe,SYSTEM_LANGUAGE_BUNDLES:me,TOOLBAR_BOTTOM:te,TOOLBAR_BOTTOM_CENTER:Ve,TOOLBAR_BOTTOM_END:Ke,TOOLBAR_MAIN:Fe,TOOLBAR_MAIN_CENTER:We,TOOLBAR_MAIN_RIGHT:fe,TOPIC_CONTRIBUTEIONS_CHANGED:Be,TOPIC_SETTINGS_CHANGED:ue,TOPIC_WORKSPACE_CHANGED:je,TOPIC_WORKSPACE_CONNECTED:He,WorkspaceService:Ye,activeEditorSignal:Qe,activePartSignal:Xe,activeSelectionSignal:Je,activeTasksSignal:Ze,appLoaderService:et,appSettings:I,applyAppHostConfig:tt,commandRegistry:M,confirmDialog:J,contributionRegistry:E,createLogger:at,editorRegistry:X,esmShService:st,extensionRegistry:it,i18n:ce,i18nLazy:ot,logger:rt,packageInfoService:nt,partDirtySignal:lt,persistenceService:ct,promptDialog:dt,publish:pt,registerAll:we,rootContext:be,subscribe:Q,taskService:pe,toastError:L,toastInfo:ht,toastWarning:gt,treeNodeComparator:ut,uiContext:he,unsubscribe:mt,watchSignal:vt,workspaceService:le},Symbol.toStringTag,{value:"Module"})),wt=`You are an assistant in a web application with workspace, editors, and AI chat.
