import{f as H,w as ot,k as $e,y as P,q as _,n as x,R as U,j as c,U as v,o as lt,m as R,V as ct,z as te,l as k,K as He,t as B,C as ie,W as pt,a as dt,A as ht,s as ut,v as we,e as Fe,x as gt,X as mt,T as Oe,r as ft,E as wt,Q as bt}from"./main-DA1jwneq.js";import{C as be,b as vt,P as Ze,K as j,a as W,T as Ke,E as kt,c as xt,t as me,d as yt}from"./ai-service-WK1ufJtt.js";const $t=`You are an assistant in a web application with workspace, editors, and AI chat.
...
`,t=t.substring(u.length+1),o=!0),!o){let A=this.rules.other.nextBulletRegex(d),L=this.rules.other.hrRegex(d),ae=this.rules.other.fencesBeginRegex(d),De=this.rules.other.headingBeginRegex(d),nt=this.rules.other.htmlBeginRegex(d);for(;t;){let ge=t.split(`
`,1)[0],Z;if(u=ge,this.options.pedantic?(u=u.replace(this.rules.other.listReplaceNesting,"  "),Z=u):Z=u.replace(this.rules.other.tabCharGlobal,"    "),ae.test(u)||De.test(u)||nt.test(u)||A.test(u)||L.test(u))break;if(Z.search(this.rules.other.nonSpaceChar)>=d||!u.trim())p+=`
`+Z.slice(d);else{if(b||f.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||ae.test(f)||De.test(f)||L.test(f))break;p+=`
`+u}!b&&!u.trim()&&(b=!0),h+=ge+`
