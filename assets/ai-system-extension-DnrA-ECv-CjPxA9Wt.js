import{_ as e,d as t,g as n,l as r}from"./fs-access-DHrXww7b-DkktKkYZ.js";import{D as i,F as a,G as o,I as s,J as c,K as l,L as u,M as d,N as f,O as p,R as m,Y as h,_ as ee,b as g,dt as te,ht as _,j as v,l as ne,mt as y,n as b,o as re,p as ie,s as ae,ut as x,v as oe,x as se}from"./dist-G6azY8Wq.js";import{a as ce,c as le,d as ue,i as de,n as fe,o as pe,r as me,s as he,t as ge,u as S}from"./ai-service-CQaQJORq-QYcBOA9_.js";function C(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var w=C();function _e(e){w=e}var T={exec:()=>null};function E(e,t=``){let n=typeof e==`string`?e:e.source,r={replace:(e,t)=>{let i=typeof t==`string`?t:t.source;return i=i.replace(D.caret,`$1`),n=n.replace(e,i),r},getRegex:()=>new RegExp(n,t)};return r}var ve=(()=>{try{return!0}catch{return!1}})(),D={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,`i`)},ye=/^(?:[ \t]*(?:\n|$))+/,be=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,xe=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,O=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Se=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Ce=/(?:[*+-]|\d{1,9}[.)])/,we=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Te=E(we).replace(/bull/g,Ce).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,``).getRegex(),Ee=E(we).replace(/bull/g,Ce).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),De=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Oe=/^[^\n]+/,ke=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Ae=E(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace(`label`,ke).replace(`title`,/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),je=E(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Ce).getRegex(),k=`address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,A=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Me=E(`^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))`,`i`).replace(`comment`,A).replace(`tag`,k).replace(`attribute`,/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Ne=E(De).replace(`hr`,O).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,k).getRegex(),j={blockquote:E(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace(`paragraph`,Ne).getRegex(),code:be,def:Ae,fences:xe,heading:Se,hr:O,html:Me,lheading:Te,list:je,newline:ye,paragraph:Ne,table:T,text:Oe},Pe=E(`^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)`).replace(`hr`,O).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`blockquote`,` {0,3}>`).replace(`code`,`(?: {4}| {0,3}	)[^\\n]`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,k).getRegex(),Fe={...j,lheading:Ee,table:Pe,paragraph:E(De).replace(`hr`,O).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`table`,Pe).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,k).getRegex()},Ie={...j,html:E(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace(`comment`,A).replace(/tag/g,`(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b`).getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:T,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:E(De).replace(`hr`,O).replace(`heading`,` *#{1,6} *[^
]`).replace(`lheading`,Te).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`|fences`,``).replace(`|list`,``).replace(`|html`,``).replace(`|tag`,``).getRegex()},Le=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Re=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,ze=/^( {2,}|\\)\n(?!\s*$)/,Be=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,M=/[\p{P}\p{S}]/u,Ve=/[\s\p{P}\p{S}]/u,He=/[^\s\p{P}\p{S}]/u,Ue=E(/^((?![*_])punctSpace)/,`u`).replace(/punctSpace/g,Ve).getRegex(),We=/(?!~)[\p{P}\p{S}]/u,Ge=/(?!~)[\s\p{P}\p{S}]/u,Ke=/(?:[^\s\p{P}\p{S}]|~)/u,qe=E(/link|precode-code|html/,`g`).replace(`link`,/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace(`precode-`,ve?"(?<!`)()":"(^^|[^`])").replace(`code`,/(?<b>`+)[^`]+\k<b>(?!`)/).replace(`html`,/<(?! )[^<>]*?>/).getRegex(),Je=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Ye=E(Je,`u`).replace(/punct/g,M).getRegex(),Xe=E(Je,`u`).replace(/punct/g,We).getRegex(),Ze=`^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,Qe=E(Ze,`gu`).replace(/notPunctSpace/g,He).replace(/punctSpace/g,Ve).replace(/punct/g,M).getRegex(),$e=E(Ze,`gu`).replace(/notPunctSpace/g,Ke).replace(/punctSpace/g,Ge).replace(/punct/g,We).getRegex(),et=E(`^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)`,`gu`).replace(/notPunctSpace/g,He).replace(/punctSpace/g,Ve).replace(/punct/g,M).getRegex(),tt=E(/\\(punct)/,`gu`).replace(/punct/g,M).getRegex(),nt=E(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace(`scheme`,/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace(`email`,/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),rt=E(A).replace(`(?:-->|$)`,`-->`).getRegex(),it=E(`^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>`).replace(`comment`,rt).replace(`attribute`,/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),N=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,at=E(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace(`label`,N).replace(`href`,/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace(`title`,/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),ot=E(/^!?\[(label)\]\[(ref)\]/).replace(`label`,N).replace(`ref`,ke).getRegex(),st=E(/^!?\[(ref)\](?:\[\])?/).replace(`ref`,ke).getRegex(),ct=E(`reflink|nolink(?!\\()`,`g`).replace(`reflink`,ot).replace(`nolink`,st).getRegex(),lt=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,ut={_backpedal:T,anyPunctuation:tt,autolink:nt,blockSkip:qe,br:ze,code:Re,del:T,emStrongLDelim:Ye,emStrongRDelimAst:Qe,emStrongRDelimUnd:et,escape:Le,link:at,nolink:st,punctuation:Ue,reflink:ot,reflinkSearch:ct,tag:it,text:Be,url:T},dt={...ut,link:E(/^!?\[(label)\]\((.*?)\)/).replace(`label`,N).getRegex(),reflink:E(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(`label`,N).getRegex()},P={...ut,emStrongRDelimAst:$e,emStrongLDelim:Xe,url:E(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace(`protocol`,lt).replace(`email`,/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:E(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace(`protocol`,lt).getRegex()},ft={...P,br:E(ze).replace(`{2,}`,`*`).getRegex(),text:E(P.text).replace(`\\b_`,`\\b_| {2,}\\n`).replace(/\{2,\}/g,`*`).getRegex()},F={normal:j,gfm:Fe,pedantic:Ie},I={normal:ut,gfm:P,breaks:ft,pedantic:dt},pt={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},mt=e=>pt[e];function L(e,t){if(t){if(D.escapeTest.test(e))return e.replace(D.escapeReplace,mt)}else if(D.escapeTestNoEncode.test(e))return e.replace(D.escapeReplaceNoEncode,mt);return e}function ht(e){try{e=encodeURI(e).replace(D.percentDecode,`%`)}catch{return null}return e}function gt(e,t){let n=e.replace(D.findPipe,(e,t,n)=>{let r=!1,i=t;for(;--i>=0&&n[i]===`\\`;)r=!r;return r?`|`:` |`}).split(D.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push(``);for(;r<n.length;r++)n[r]=n[r].trim().replace(D.slashPipe,`|`);return n}function R(e,t,n){let r=e.length;if(r===0)return``;let i=0;for(;i<r;){let a=e.charAt(r-i-1);if(a===t&&!n)i++;else if(a!==t&&n)i++;else break}return e.slice(0,r-i)}function _t(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]===`\\`)r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return n>0?-2:-1}function vt(e,t,n,r,i){let a=t.href,o=t.title||null,s=e[1].replace(i.other.outputLinkReplace,`$1`);r.state.inLink=!0;let c={type:e[0].charAt(0)===`!`?`image`:`link`,raw:n,href:a,title:o,text:s,tokens:r.inlineTokens(s)};return r.state.inLink=!1,c}function yt(e,t,n){let r=e.match(n.other.indentCodeCompensation);if(r===null)return t;let i=r[1];return t.split(`
...
`;for(let{label:e,...t}of[{label:`Ollama (Local)`,name:`ollama`,model:`gemma3:12b`,chatApiEndpoint:`https://<your-server>/v1/chat/completions`,apiKey:``},{label:`OpenWebUI (Self Hosted)`,name:`openwebui`,model:`gemma3:12b`,chatApiEndpoint:`https://<your-server>/api/v1/chat/completion`,apiKey:``},{label:`OpenAI`,name:`openai`,model:`gpt-4.1`,chatApiEndpoint:`https://api.openai.com/v1/chat/completions`,apiKey:`<your api key>`},{label:`Groq`,name:`groq`,model:`llama-3.1-8b-instant`,chatApiEndpoint:`https://api.groq.com/openai/v1/chat/completions`,apiKey:`<your api key>`},{label:`Cerebras`,name:`cerebras`,model:`llama3.1-8b`,chatApiEndpoint:`https://api.cerebras.ai/v1/chat/completions`,apiKey:`<your api key>`},{label:`WebLLM`,name:`webllm`,model:`gemma-2-9b-it-q4f16_1-MLC`,chatApiEndpoint:``,apiKey:``,parameters:{context_window_size:4096}},{label:`Mistral`,name:`mistral`,model:`mistral-large-latest`,chatApiEndpoint:`https://api.mistral.ai/v1/chat/completions`,apiKey:`<your api key>`},{label:`LiteLLM`,name:`litellm`,model:`gpt-3.5-turbo`,chatApiEndpoint:`https://<your-server>/v1/chat/completions`,apiKey:`<your api key>`}])l.registerContribution(fe,{target:fe,label:e,provider:t});l.registerContribution(me,{label:`App State Enhancer`,enhancer:{priority:20,enhance:async(e,t)=>{try{let t=await r.getWorkspace(),n=b.getEditorArea()?.getActiveEditor(),i={workspace:t?.getName()||null,activeEditor:n?{title:n.input?.title||null,editorId:n.input?.editorId||null}:null};return`${e}\n\n***App's state:***\n${JSON.stringify(i,null,2)}`}catch{return e}}}});var St=class{constructor(){this.activeSession=null,this.pastSessions=[]}async load(){let e=await g.get(`aiChatSessions`);if(e){if(e.active&&Array.isArray(e.history))this.activeSession=e.active;else if(e.activeSessionId&&Array.isArray(e.sessions))this.activeSession=e.sessions.find(t=>t.id===e.activeSessionId)||null,this.pastSessions=e.sessions.filter(t=>t.id!==e.activeSessionId);else if(Array.isArray(e.all)){let[t,...n]=e.all.sort((e,t)=>t.updatedAt-e.updatedAt);this.activeSession=t||null,this.pastSessions=n}}}async persist(){let e=[];this.activeSession&&e.push(this.activeSession),e.push(...this.pastSessions),await g.set(`aiChatSessions`,{all:e,activeSessionId:this.activeSession?.id||null})}createSession(){let e={id:`session-${Date.now()}-${Math.random().toString(36).slice(2,9)}`,history:[],title:`New Chat`,createdAt:Date.now(),updatedAt:Date.now()};return this.activeSession&&this.pastSessions.unshift(this.activeSession),this.activeSession=e,this.persist(),e}getActiveSession(){return this.activeSession}getActiveSessionId(){return this.activeSession?.id||``}switchToSession(e){if(this.activeSession?.id===e)return!0;let t=this.pastSessions.findIndex(t=>t.id===e);if(t===-1)return!1;let[n]=this.pastSessions.splice(t,1);return n?(this.activeSession&&this.pastSessions.unshift(this.activeSession),this.activeSession=n,this.persist(),!0):!1}getPastSessions(){return this.pastSessions}deletePastSession(e){let t=this.pastSessions.findIndex(t=>t.id===e);return t===-1?!1:(this.pastSessions.splice(t,1),this.persist(),!0)}addMessage(e){this.activeSession&&(this.activeSession.history.push(e),this.activeSession.updatedAt=Date.now(),this.persist())}setTitle(e){this.activeSession&&(this.activeSession.title=e,this.persist())}generateTitle(e){let t=e.trim();return t?t.length<=30?t:t.substring(0,30).trim()+`...`:`New Chat`}deleteActiveAndSwitchToFirst(){this.activeSession&&(this.activeSession=this.pastSessions.shift()||null,this.activeSession||this.createSession(),this.persist())}},Ct=class{constructor(e){this.streamingMessages=new Map,this.currentIndex=-1,this.pendingUpdate=!1,this.onUpdate=e}createStreamingMessage(e){let t=++this.currentIndex;return this.streamingMessages.set(t,{message:{role:e,content:``},isStreaming:!0}),t}updateStreamingMessage(e,t){let n=this.streamingMessages.get(e);n&&(n.message.content+=t,this.scheduleUpdate())}completeStreamingMessage(e,t){let n=this.streamingMessages.get(e);n&&(n.message=t,n.isStreaming=!1)}removeStreamingMessage(e){this.streamingMessages.delete(e)}findStreamingMessage(e){return Array.from(this.streamingMessages.values()).find(t=>t.message.role===e)?.message}getAllStreamingMessages(){return Array.from(this.streamingMessages.values())}scheduleUpdate(){this.pendingUpdate||(this.pendingUpdate=!0,this.rafHandle=requestAnimationFrame(()=>{this.pendingUpdate=!1,this.onUpdate?.()}))}cancelUpdates(){this.rafHandle!==void 0&&(cancelAnimationFrame(this.rafHandle),this.rafHandle=void 0,this.pendingUpdate=!1)}reset(){this.streamingMessages.clear(),this.cancelUpdates(),this.currentIndex=-1}},wt=`aiViewChat`,Tt=class{constructor(e){this.aiService=e,this.providers=[],this.availableModels=[],this.loadingModels=!1,this.providerFactory=new pe}async initialize(){this.providers=await this.aiService.getProviders()||[];let e=await this.aiService.getDefaultProvider();e&&(this.selectedProvider=e)}getProviders(){return this.providers}getSelectedProvider(){return this.selectedProvider}setSelectedProvider(e){this.selectedProvider=e}getAvailableModels(){return this.availableModels}isLoadingModels(){return this.loadingModels}async saveSettings(e,t,n,r,i){let a={...await g.get(wt)||{}};r!==void 0&&(a.requireToolApproval=r),i!==void 0&&(a.toolApprovalAllowlist=i),await g.set(wt,a);let o=this.providers.find(t=>t.name===e);o&&(this.selectedProvider={...o,model:t,...n!==void 0&&{apiKey:n}},await this.updateProviderInAIConfig(e,{model:t,...n!==void 0&&{apiKey:n}}),await this.aiService.setDefaultProvider(e))}async updateProviderInAIConfig(e,t){let n=await g.get(`aiConfig`)||{};if(!n.providers||!Array.isArray(n.providers))return;let r=n.providers.findIndex(t=>t.name===e);r>=0&&(n.providers[r]={...n.providers[r],...t},await g.set(ce,n))}async loadToolApprovalAllowlist(){return(await g.get(wt)||{}).toolApprovalAllowlist||[]}async fetchModels(e){let t=this.providers.find(t=>t.name===e);if(t){this.loadingModels=!0,this.availableModels=[];try{this.availableModels=await this.providerFactory.getProvider(t).getAvailableModels?.(t)??[]}finally{this.loadingModels=!1}}}},Et=class{constructor(){this.groups=new Map}createGroup(e,t,n,r,i){let a=`group-${Date.now()}-${Math.random().toString(36).slice(2,9)}`;this.currentGroupId=a;let o={id:a,sessionId:e,userMessageIndex:t,userMessage:n,timestamp:new Date,agents:new Map,messageIndices:new Map};return r.forEach(e=>{let{label:t,icon:n}=i(e);o.agents.set(e,{role:e,label:t,icon:n,status:`streaming`})}),this.groups.set(a,o),a}getGroup(e){return this.groups.get(e)}updateAgentStatus(e,t,n,r,i){let a=this.groups.get(e);if(!a)return;let o=a.agents.get(t);o&&(o.status=n,r&&(o.message=r),i!==void 0&&(o.messageIndex=i,a.messageIndices.set(t,i)))}getGroupsForSession(e){return Array.from(this.groups.values()).filter(t=>t.sessionId===e)}findGroupForUserMessage(e,t,n){return Array.from(this.groups.values()).find(r=>r.sessionId===e&&r.userMessageIndex===t&&r.userMessage===n)}findGroupForMessage(e,t,n){return Array.from(this.groups.values()).find(r=>r.sessionId===e&&r.messageIndices.get(t)===n)}getCurrentGroupId(){return this.currentGroupId}setCurrentGroupId(e){this.currentGroupId=e}clearCurrentGroup(){this.currentGroupId=void 0}getAllGroups(){return Array.from(this.groups.values())}clearAll(){this.groups.clear(),this.currentGroupId=void 0}},K=class extends x{constructor(...e){super(...e),this.isStreaming=!1,this.showHeader=!0}updated(e){super.updated(e),(e.has(`message`)||!this.hasAttribute(`data-is-user`))&&this.updateAlignment()}updateAlignment(){this.message&&this.setAttribute(`data-is-user`,String(this.message.role===`user`))}copyToClipboard(e){navigator.clipboard.writeText(e).catch(e=>console.error(`Failed to copy:`,e))}processMarkdownContent(e){return e.includes(`code-blocwrapper`)?e:e.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,t,n)=>`
            ...
            <div class="message-wrapper ${t?`user`:`assistant`} ${this.isStreaming?`streaming`:``}">
                ...
                <div class="message-content-wrapper ${t?`user`:``}">
                    <div class="message-content">
                        ${f(this.processMarkdownContent(G.parse(e.content||``)))}
                        ${d(this.isStreaming,()=>y`<span class="streaming-cursor">▋</span>`)}
                    </div>
                    ${d(t,()=>y`
                        <wa-button variant="neutral" appearance="plain" size="small" title="Copy"
                            @click="${()=>this.copyToClipboard(e.content)}">
    ...
    `}};v([u({type:Object,attribute:!1})],K.prototype,`message`,void 0),v([u({type:Boolean})],K.prototype,`isStreaming`,void 0),v([u({type:Boolean})],K.prototype,`showHeader`,void 0),v([u({type:Number,attribute:!1})],K.prototype,`messageIndex`,void 0),K=v([m(`lyra-ai-chat-message`)],K);var q=class extends x{constructor(...e){super(...e),this.value=``,this.disabled=!1,this.busy=!1,this.hasProvider=!0}onInput(e){this.value=e.target.value,this.dispatchEvent(new CustomEvent(`input-change`,{detail:{value:this.value},bubbles:!0,composed:!0}))}onKeyDown(e){e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),this.send())}async send(){if(!this.value.trim()||this.disabled||!this.hasProvider)return;let e=this.value;this.value=``,this.requestUpdate(),await this.updateComplete,this.textareaElement&&(this.textareaElement.value=``,this.textareaElement.focus()),this.dispatchEvent(new CustomEvent(`send`,{detail:{value:e},bubbles:!0,composed:!0}))}cancel(){this.dispatchEvent(new CustomEvent(`cancel`,{bubbles:!0,composed:!0}))}render(){return y`
    ...
    `}};v([u({type:String})],q.prototype,`value`,void 0),v([u({type:Boolean})],q.prototype,`disabled`,void 0),v([u({type:Boolean})],q.prototype,`busy`,void 0),v([u({type:Boolean})],q.prototype,`hasProvider`,void 0),v([a(`wa-textarea`)],q.prototype,`textareaElement`,void 0),q=v([m(`lyra-ai-chat-input`)],q);var J=class extends x{copyToClipboard(e){navigator.clipboard.writeText(e).catch(e=>console.error(`Failed to copy:`,e))}renderStatusIcon(e){switch(e){case`streaming`:return y`<wa-icon name="spinner" class="spinning"></wa-icon>`;case`completed`:return y`<wa-icon name="check-circle" class="status-success"></wa-icon>`;case`error`:return y`<wa-icon name="exclamation-circle" class="status-error"></wa-icon>`}}renderCard(e,t){return t?y`
        ...
        `:y`
            ...
            `}render(){if(!this.group)return y``;let e=Array.from(this.group.agents.values()),t=e.filter(e=>e.status===`completed`).length,n=e.filter(e=>e.status===`streaming`).length,r=e.filter(e=>e.status===`error`).length,i=e.length>0&&t+r===e.length;return y`
                ...
                ${d(e.length!==1,()=>y`
                    <div class="group-header">
                        ...
                        <span class="status-badge">
                            ${d(n>0,()=>y`<span class="streaming">${n} responding</span>`)}
                            ${d(i,()=>y`<span class="done">All completed (${t})</span>`)}
                        </span>
                    </div>
                `)}
    ...
    `}};v([u({type:Object,attribute:!1})],J.prototype,`group`,void 0),v([u({type:Function,attribute:!1})],J.prototype,`findStreamingMessage`,void 0),J=v([m(`lyra-ai-agent-response-group`)],J);var Dt=class extends x{constructor(...e){super(...e),this.pendingApprovals=new Map}approve(e,t){this.dispatchEvent(new CustomEvent(`approve`,{detail:{approvalId:e,approval:t},bubbles:!0,composed:!0})),t.resolve(!0),this.pendingApprovals.delete(e),this.requestUpdate()}deny(e,t){t.resolve(!1),this.pendingApprovals.delete(e),this.requestUpdate()}formatArgs(e){let t={};try{t=JSON.parse(e)}catch{}return Object.entries(t).map(([e,t])=>`${e}=${JSON.stringify(t)}`).join(`, `)}render(){return this.pendingApprovals.size===0?y``:y`
            <div class="approval-container">
                ${Array.from(this.pendingApprovals.entries()).map(([e,t])=>{let n=t.request.toolCalls,r=n[0];return y`
                        <wa-details class="approval-item">
                            ...
                            <div class="approval-detail">
                                ...
                                <ul class="tool-list">
                                    ${p(n,e=>e.id,e=>{let n=this.formatArgs(e.function.arguments||`{}`);return y`
                                            <li class="tool-item">
    ...
    `}};v([u({type:Map,attribute:!1})],Dt.prototype,`pendingApprovals`,void 0),Dt=v([m(`lyra-ai-tool-approval`)],Dt);var Y=class extends x{constructor(...e){super(...e),this.message=`No AI provider configured`,this.hint=`Click the settings icon to configure an AI provider`}render(){return y`
                    ...
                    <div class="panel-body">
                        <div class="artifact-list">
                            ${p(this.artifacts,e=>e.id,e=>y`
                                ...
                                ${d(this.selectedArtifact?.id===e.id,()=>y`
    ...
    `}};v([u({type:Array,attribute:!1})],Z.prototype,`artifacts`,void 0),v([s()],Z.prototype,`expanded`,void 0),v([s()],Z.prototype,`selectedArtifact`,void 0),Z=v([m(`lyra-ai-workspace-panel`)],Z);var Q=class extends ae{constructor(...e){super(...e),this.sessionManager=new St,this.streamManager=new Ct(()=>{this.requestUpdate(),this.scrollDebounceTimer&&clearTimeout(this.scrollDebounceTimer),this.scrollDebounceTimer=setTimeout(async()=>{await this.updateComplete,this.scrollToBottom(),this.scrollDebounceTimer=void 0},100)}),this.providerManager=new Tt(S),this.agentGroupManager=new Et,this.busy=!1,this.inputValue=``,this.requireToolApproval=!0,this.showHistory=!1,this.currentArtifacts=[],this.pendingToolApprovals=new Map,this.toolApprovalAllowlist=new Set}async doBeforeUI(){this.subscribe(he,()=>this.onAIConfigChanged()),await this.sessionManager.load(),this.sessionManager.getActiveSession()||this.sessionManager.createSession(),await this.providerManager.initialize(),await this.loadSettings(),this.requestUpdate()}async onAIConfigChanged(){await this.providerManager.initialize(),await this.loadSettings(),this.requestUpdate()}async loadSettings(){this.requireToolApproval=(await g.get(`aiConfig`)||{}).requireToolApproval!==!1;let e=await this.providerManager.loadToolApprovalAllowlist();this.toolApprovalAllowlist=new Set(e)}async scrollToBottom(){await this.updateComplete;let e=this.shadowRoot?.querySelector(`wa-scroller.chat-messages`);if(!e)return;let t=e.shadowRoot?.querySelector(`.scroll-container`);t?t.scrollTop=t.scrollHeight:e.scrollTo&&e.scrollTo({top:e.scrollHeight,behavior:`smooth`})}resetViewState(){this.inputValue=``,this.showHistory=!1,this.currentTaskPlan=void 0,this.currentArtifacts=[],this.requestUpdate()}createNewSession(){this.sessionManager.createSession(),this.resetViewState()}switchToSession(e){this.sessionManager.switchToSession(e)&&this.resetViewState()}deletePastSession(e){this.sessionManager.deletePastSession(e),this.requestUpdate()}async sendMessage(){let e=this.inputValue.trim();!e||this.busy||(this.inputValue=``,await this.handlePrompt(e))}async handleResend(e){!e||e.role!==`user`||await this.handlePrompt(e.content)}cancelStream(){this.abortController?.abort(),this.abortController=void 0,this.busy=!1,this.streamManager.cancelUpdates()}async handlePrompt(t){if(t.startsWith(`/`)){await this.runCommand(t.substring(1));return}let n=this.providerManager.getSelectedProvider();if(!n){h(`Please configure an AI provider in settings`);return}let r=this.sessionManager.getActiveSession();if(!r)return;let a=S.createMessage(t);this.sessionManager.addMessage(a),r.history.length===1&&this.sessionManager.setTitle(this.sessionManager.generateTitle(t)),this.requestUpdate(),await this.updateComplete,this.scrollToBottom(),this.busy=!0,this.currentTaskPlan=void 0,this.currentArtifacts=[],this.abortController=new AbortController;let s=new Map,c={history:[...r.history]},l=r.id,u=o.createExecutionContext(),d=e.createChild({...u}),f=S.getAgentContributions();if(f.length===0){h(`No agents are registered.`),this.busy=!1;return}let p=f.filter(e=>!e.canHandle||e.canHandle({...d.getProxy(),userPrompt:t})).sort((e,t)=>(t.priority||0)-(e.priority||0));if(p.length===0){h(`No agents available. Available: ${f.map(e=>e.role).join(`, `)}`),this.busy=!1;return}let m=p.map(e=>e.role),ee=this.sessionManager.getActiveSession();if(!ee)return;let g=this.agentGroupManager.createGroup(l,ee.history.length-1,a,m,e=>{let t=f.find(t=>t.role===e);return{label:t?.label||e,icon:t?.icon||`robot`}});i.runAsync(`Calling AI assistant`,async()=>S.executeAgentWorkflow({chatContext:c,chatConfig:n,callContext:d,execution:`parallel`,stream:!0,signal:this.abortController.signal,roles:m,requireToolApproval:this.requireToolApproval,onToolApprovalRequest:async(e,t)=>t.toolCalls.every(e=>this.toolApprovalAllowlist.has(e.function.name))?!0:new Promise(n=>{let r=`approval-${Date.now()}-${Math.random().toString(36).slice(2,9)}`,i={role:e,request:t,resolve:n,alwaysAllowSelections:new Map};this.pendingToolApprovals.set(r,i),this.requestUpdate()}),onAgentStart:async e=>{let t=this.streamManager.createStreamingMessage(e);s.set(e,t),this.agentGroupManager.updateAgentStatus(g,e,`streaming`),this.requestUpdate(),await this.updateComplete,this.scrollToBottom()},onToken:(e,t)=>{let n=s.get(e);n!==void 0&&this.streamManager.updateStreamingMessage(n,t)},onAgentComplete:async(e,t)=>{let n=this.sessionManager.getActiveSession();if(!n||n.id!==l)return;let r=s.get(e);if(r!==void 0){this.streamManager.completeStreamingMessage(r,t);let i=n.history.length;this.sessionManager.addMessage(t),s.delete(e),this.streamManager.removeStreamingMessage(r),this.agentGroupManager.updateAgentStatus(g,e,`completed`,t,i),this.requestUpdate(),await this.updateComplete,this.scrollToBottom()}},onAgentError:(e,t)=>{let n=s.get(e);n!==void 0&&(this.streamManager.removeStreamingMessage(n),s.delete(e)),this.agentGroupManager.updateAgentStatus(g,e,`error`,{role:e,content:`Error: ${t.message}`}),this.requestUpdate(),h(`Agent ${e} error: ${t.message}`)}}).then(()=>{this.agentGroupManager.clearCurrentGroup()})).catch(e=>{e?.name!==`AbortError`&&h(`${e}`)}).finally(async()=>{this.busy=!1,this.abortController=void 0,this.streamManager.reset(),this.agentGroupManager.clearCurrentGroup(),this.requestUpdate()})}async runCommand(e){let t=e.trim().split(/\s+/);if(t.length===0)return;let n=t.shift(),r=o.getCommand(n);if(!r){h(`Command not found: ${n}`);return}let i={};t.forEach((e,t)=>{r.parameters?.[t]&&(i[r.parameters[t].name]=e)}),await o.execute(n,o.createExecutionContext(i)),this.requestUpdate()}handleToolApproval(e){let{approvalId:t,approval:n}=e.detail;Array.from(n.alwaysAllowSelections.entries()).filter(([,e])=>e).map(([e])=>e).forEach(e=>this.toolApprovalAllowlist.add(e)),this.pendingToolApprovals.delete(t),this.requestUpdate()}renderMessage(e,t,n=!1){return y`
        ...
        `}renderToolbar(){let e=this.sessionManager.getPastSessions();return y`
        ...
        `}renderContent(){let e=this.sessionManager.getActiveSession(),t=this.providerManager.getSelectedProvider();return y`
            <div class="chat-container">
                <wa-scroller class="chat-messages" orientation="vertical">
                    <div class="chat-content">
                        ...
                        `,()=>d(!e||e.history.length===0,()=>y`
                            <lyra-ai-empty-state message="How can I help you?" hint=""></lyra-ai-empty-state>
                        `,()=>y`
                            ${e.history.map((t,n)=>{let r=this.agentGroupManager.findGroupForUserMessage(e.id,n,t);return r&&t.role===`user`?y`
                                        <lyra-ai-chat-message
                                            .message="${t}"
                                            .isStreaming="${!1}"
                                            .showHeader="${!0}"
                                    ...
                                    `:this.agentGroupManager.findGroupForMessage(e.id,t.role,n)?y``:this.renderMessage(t,n)})}
                            ...
                            ${d(this.busy&&this.streamManager.getAllStreamingMessages().length===0,()=>y`
    ...
    `}};v([s()],Q.prototype,`busy`,void 0),v([s()],Q.prototype,`inputValue`,void 0),v([s()],Q.prototype,`requireToolApproval`,void 0),v([s()],Q.prototype,`showHistory`,void 0),v([s()],Q.prototype,`currentTaskPlan`,void 0),v([s()],Q.prototype,`currentArtifacts`,void 0),v([s()],Q.prototype,`pendingToolApprovals`,void 0),Q=v([m(`lyra-aiview`)],Q);var jt=class extends re{constructor(...e){super(...e),this.totalUsage={...de},this.providerUsage={}}connectedCallback(){super.connectedCallback(),this.loadUsage(),t(le,()=>{this.loadUsage()})}async loadUsage(){this.totalUsage=await ue.getTotalUsage(),this.providerUsage=await ue.getAllProviderUsage(),this.requestUpdate()}formatNumber(e){return e>=1e6?(e/1e6).toFixed(2)+`M`:e>=1e3?(e/1e3).toFixed(1)+`K`:e.toString()}async handleReset(){await se(`Reset all token usage statistics?`)&&(await ue.reset(),await this.loadUsage())}renderStatItem(e,t){return y`
            <div class="stat-item">
                <span class="stat-label">${e}</span>
                <span class="stat-value">${this.formatNumber(t)}</span>
            </div>
        `}render(){return this.totalUsage.totalTokens===0?y``:y`
            <wa-dropdown placement="top-end" distance="8">
                ...
                ${Object.keys(this.providerUsage).length>0?y`
                    <wa-divider></wa-divider>
                    <h6>By Provider</h6>
                    ${Object.entries(this.providerUsage).map(([e,t])=>y`
                        <wa-dropdown-item>
    ...
    `}};jt=v([m(`lyra-token-usage`)],jt);var $=class extends ae{constructor(...e){super(...e),this.providers=[],this.defaultProvider=``,this.hasChanges=!1,this.availableModels=[],this.loadingModels=!1,this.requireToolApproval=!0,this.smartToolDetection=!1,this.editingState={},this.providerFactory=new pe}async doInitUI(){await this.loadConfig(),t(he,()=>this.loadConfig()),t(oe,()=>this.loadConfig())}async loadConfig(){let e=await g.get(ce);this.aiConfig=e;let t=l.getContributions(fe).map(e=>e.provider),n=e?.providers||[],r=new Set(n.map(e=>e.name));this.providers=[...n,...t.filter(e=>!r.has(e.name))],this.defaultProvider=e?.defaultProvider||``,this.requireToolApproval=e?.requireToolApproval!==!1,this.smartToolDetection=e?.smartToolDetection===void 0?!1:e.smartToolDetection,this.editingState={},this.hasChanges=!1,this.markDirty(!1)}getEditValue(e,t){let n=this.editingState[e];if(n&&t in n)return n[t]??``;let r=this.providers[e];return r?r[t]??``:``}setEditValue(e,t,n){this.editingState={...this.editingState,[e]:{...this.editingState[e]||{},[t]:n}},this.providers=this.providers.map((r,i)=>i===e?{...r,[t]:n}:r),this.markDirtyAndUpdate()}markDirtyAndUpdate(){this.hasChanges=!0,this.markDirty(!0)}async fetchModels(e){let t=this.providers[e];if(t){this.loadingModels=!0,this.availableModels=[];try{let e=this.providerFactory.getProvider(t);if(e.getAvailableModels){let n=await e.getAvailableModels(t);this.availableModels=Array.isArray(n)?n:[]}}finally{this.loadingModels=!1}}}async saveConfig(){let e={...this.aiConfig??{},defaultProvider:this.defaultProvider,providers:this.providers,requireToolApproval:this.requireToolApproval,smartToolDetection:this.smartToolDetection};await g.set(ce,e),this.aiConfig=e,this.hasChanges=!1,this.markDirty(!1)}async save(){this.hasChanges&&await this.saveConfig()}addProvider(){this.providers=[...this.providers,{name:`new-provider`,model:``,apiKey:``,chatApiEndpoint:``}],this.markDirtyAndUpdate()}async deleteProvider(e){let t=this.providers[e];await se(`Delete provider "${t.name}"?`)&&(this.defaultProvider===t.name&&(this.defaultProvider=``),this.providers=this.providers.filter((t,n)=>n!==e),this.markDirtyAndUpdate())}renderProviderField(e,t,n=`text`){let r=this.getEditValue(e,t);return y`
        ...
        `}renderContent(){return y`
            <div class="editor">
                ...
                ${d(this.providers.length===0,()=>y`
                    <div class="empty-state"><p>No providers configured.</p></div>
                `,()=>y`
                    <div class="providers-list">
                        ${p(this.providers,(e,t)=>t,(e,t)=>y`
                            <div class="provider-card">
                                <div class="provider-card-header ${this.defaultProvider===e.name?`is-default`:``}">
                                    <span class="provider-name">${e.name}</span>
                                    ${this.defaultProvider===e.name?y`<span class="default-badge">Default</span>`:y`<wa-button appearance="plain" size="small" title="Set as default"
                                ...
                                <div class="provider-fields">
                                    ...
                                    <div class="field-row">
                                        ...
                                        ${d(this.loadingModels,()=>y`
                                            <wa-progress-ring indeterminate size="small"></wa-progress-ring>
                                        `)}
                                        ${d(this.availableModels.length>0,()=>y`
                                            <wa-dropdown
    ...
    `}};v([u({attribute:!1})],$.prototype,`input`,void 0),v([s()],$.prototype,`providers`,void 0),v([s()],$.prototype,`defaultProvider`,void 0),v([s()],$.prototype,`hasChanges`,void 0),v([s()],$.prototype,`availableModels`,void 0),v([s()],$.prototype,`loadingModels`,void 0),v([s()],$.prototype,`requireToolApproval`,void 0),v([s()],$.prototype,`smartToolDetection`,void 0),v([s()],$.prototype,`editingState`,void 0),$=v([m(`lyra-ai-config-editor`)],$),l.registerContribution(ne,{name:`aiview`,label:`AI Assistant`,icon:`robot`,component:e=>y`<lyra-aiview id="${e}"></lyra-aiview>`}),l.registerContribution(ge,{label:`App Support`,description:`General-purpose assistant that can answer questions and execute app commands`,role:`appsupport`,priority:100,icon:`question-circle`,sysPrompt:xt,tools:async()=>({enabled:!0,smartToolDetection:(await g.get(`aiConfig`))?.smartToolDetection??!1})}),l.registerContribution(ie,{target:ie,label:`Token Usage`,component:`<lyra-token-usage></lyra-token-usage>`}),b.registerEditorInputHandler({editorId:`system.ai-config-editor`,label:`AI Config`,ranking:1e3,canHandle:e=>e.key===`.system.ai-config`,handle:async e=>(e.component=t=>y`<lyra-ai-config-editor id="${t}" .input=${e}></lyra-ai-config-editor>`,e)}),c({command:{id:`open_ai_config`,name:`Open AI Configuration`,description:`Open the AI system configuration editor`,parameters:[]},handler:{execute:e=>{b.loadEditor({title:`AI Settings`,data:{},key:`.system.ai-config`,icon:`robot`,state:{}}).then()}},contribution:{target:ee,icon:`robot`,label:`AI Config`}}),n.put(`aiService`,S);