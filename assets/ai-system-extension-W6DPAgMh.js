const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/in-browser-ml-service-D9cxY0Oa.js","assets/main-DA3mdgRZ.js","assets/main-DCTlflHk.css","assets/ai-service-Xbmu7sjO.js"])))=>i.map(i=>d[i]);
import{v as C,w as rt,e as Ee,H as it,i as D,n as S,r as E,k as j,b as p,a4 as b,p as nt,t as L,a5 as ot,l as pe,_ as ae,z as N,K as Ke,d as Z,f as V,J as lt,a6 as ct,a0 as Te,q as pt,s as be,y as dt,S as ht,a7 as ut,x as ze,c as gt,C as mt,a as ft}from"./main-DA3mdgRZ.js";import{c as x,C as wt,a as ee,b as We,d as bt,t as we,P as vt,K as ve,e as kt}from"./ai-service-Xbmu7sjO.js";import"./in-browser-ml-service-D9cxY0Oa.js";const At=`You are an assistant in a web application with workspace, editors, and AI chat.
...
`,t=t.substring(g.length+1),o=!0),!o){let y=this.rules.other.nextBulletRegex(f),I=this.rules.other.hrRegex(f),z=this.rules.other.fencesBeginRegex(f),fe=this.rules.other.headingBeginRegex(f),G=this.rules.other.htmlBeginRegex(f);for(;t;){let R=t.split(`
`,1)[0],Q;if(g=R,this.options.pedantic?(g=g.replace(this.rules.other.listReplaceNesting,"  "),Q=g):Q=g.replace(this.rules.other.tabCharGlobal,"    "),z.test(g)||fe.test(g)||G.test(g)||y.test(g)||I.test(g))break;if(Q.search(this.rules.other.nonSpaceChar)>=f||!g.trim())d+=`
