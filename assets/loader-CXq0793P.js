import{d as e,f as t}from"./fs-access-DEIaNyms-RyMkFh5Y.js";import{A as n,I as r,K as i,R as a,T as o,U as s,V as c,W as l,ht as u,j as d,k as f,mt as p,s as m,u as h}from"./dist-BW9tMLZU.js";import"./lit-DJjUnliO.js";var g,_=`catalog.root`,v=class extends m{static{g=this}constructor(...e){super(...e),this.treeRef=f()}doBeforeUI(){this.rebuildTree(),this.contributionsSubscriptionToken=e(c,e=>{(e.target===`catalog.root`||e.target?.startsWith(`catalog.`))&&this.rebuildTree()})}doClose(){this.contributionsSubscriptionToken&&=(t(this.contributionsSubscriptionToken),void 0),super.doClose()}rebuildTree(){let e=i.getContributions(_);this.rootNodes=this.toTreeNodes(e),this.requestUpdate()}renderToolbar(){return p`
            <lyra-command
