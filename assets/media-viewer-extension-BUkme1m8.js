                            ...
                            <div class="overlay-layer">
                                ${this.overlays.map(a=>a.type==="bbox"?r`
                                    <div
                                        ...
                                        title="${a.label??""}"
                                    >
                                        ${a.label?r`<span class="overlay-label">${a.label}</span>`:m}
                                    </div>
                                `:a.type==="mask"?r`
                                    <img
                                        class="overlay-mask"
