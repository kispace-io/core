import{n as e}from"./fs-access-D-fDaJ8V-w6cEwJE-.js";import{B as t,N as n,R as r,_t as i,gt as a,n as o,o as s,pt as c,z as l}from"./dist-rtCeiCQp.js";var u=[`.pdf`,`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],d=e=>{let t=e.toLowerCase();return t.endsWith(`.pdf`)?`file-pdf`:t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?`image`:`file`},f=e=>{let t=e.getName().toLowerCase();return u.some(e=>t.endsWith(e))},p=[`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],m=e=>{let t=e.getName().toLowerCase();return p.some(e=>t.endsWith(e))};o.registerEditorInputHandler({editorId:`system.media-viewer`,label:`Media viewer`,canHandle:t=>t instanceof e&&f(t),handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:d(e.getName()),state:{}};return t.component=e=>a`
                            ...
                            <div class="overlay-layer">
                                ${this.overlays.map(e=>e.type===`bbox`?a`
                                    <div
                                        ...
                                        title="${e.label??``}"
                                    >
                                        ${e.label?a`<span class="overlay-label">${e.label}</span>`:c}
                                    </div>
                                `:e.type===`mask`?a`
                                    <img
                                        class="overlay-mask"
    ...
    `}};n([l({attribute:!1})],h.prototype,`input`,void 0),n([r()],h.prototype,`mediaUrl`,void 0),n([r()],h.prototype,`imageNaturalWidth`,void 0),n([r()],h.prototype,`imageNaturalHeight`,void 0),n([r()],h.prototype,`overlays`,void 0),h=n([t(`docks-media-viewer`)],h);export{h as DocksMediaViewer};