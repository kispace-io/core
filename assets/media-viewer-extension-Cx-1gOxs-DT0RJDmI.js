import{L as m,W as c,d as r,B as g,q as p,b as v,n as u,r as n,t as f}from"./config-BIuWNlpk-C_4sybHU.js";var y=Object.defineProperty,b=Object.getOwnPropertyDescriptor,l=(t,e,i,o)=>{for(var a=o>1?void 0:o?b(e,i):e,d=t.length-1,h;d>=0;d--)(h=t[d])&&(a=(o?h(e,i,a):h(a))||a);return o&&a&&y(e,i,a),a};const w=[".pdf",".jpg",".jpeg",".png",".gif",".svg",".webp",".bmp",".ico"],N=t=>{const e=t.toLowerCase();return e.endsWith(".pdf")?"file-pdf":e.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?"image":"file"},$=t=>{const e=t.getName().toLowerCase();return w.some(i=>e.endsWith(i))},I=[".jpg",".jpeg",".png",".gif",".svg",".webp",".bmp",".ico"],x=t=>{const e=t.getName().toLowerCase();return I.some(i=>e.endsWith(i))};p.registerEditorInputHandler({editorId:"system.media-viewer",label:"Media viewer",canHandle:t=>t instanceof c&&$(t),handle:async t=>{const e={title:t.getWorkspacePath(),data:t,key:t.getWorkspacePath(),icon:N(t.getName()),noOverflow:!1,state:{}};return e.component=()=>r`
    ...
    `;l([u({attribute:!1})],s.prototype,"input",2);l([n()],s.prototype,"mediaUrl",2);l([n()],s.prototype,"imageNaturalWidth",2);l([n()],s.prototype,"imageNaturalHeight",2);l([n()],s.prototype,"overlays",2);s=l([f("lyra-media-viewer")],s);export{s as LyraMediaViewer};
