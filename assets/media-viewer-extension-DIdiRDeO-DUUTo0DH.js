import{n as e}from"./fs-access-DEIaNyms-RyMkFh5Y.js";import{I as t,L as n,R as r,dt as i,ht as a,j as o,mt as s,n as c,s as l}from"./dist-BW9tMLZU.js";var u=[`.pdf`,`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],d=e=>{let t=e.toLowerCase();return t.endsWith(`.pdf`)?`file-pdf`:t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?`image`:`file`},f=e=>{let t=e.getName().toLowerCase();return u.some(e=>t.endsWith(e))},p=[`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],m=e=>{let t=e.getName().toLowerCase();return p.some(e=>t.endsWith(e))};c.registerEditorInputHandler({editorId:`system.media-viewer`,label:`Media viewer`,canHandle:t=>t instanceof e&&f(t),handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:d(e.getName()),state:{}};return t.component=e=>s`
    ...
    `}};o([n({attribute:!1})],h.prototype,`input`,void 0),o([t()],h.prototype,`mediaUrl`,void 0),o([t()],h.prototype,`imageNaturalWidth`,void 0),o([t()],h.prototype,`imageNaturalHeight`,void 0),o([t()],h.prototype,`overlays`,void 0),h=o([r(`lyra-media-viewer`)],h);export{h as LyraMediaViewer};