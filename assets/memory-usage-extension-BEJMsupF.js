import{m as c,s as d,j as o,f as u,T as l}from"./main-erQGEv3o.js";var m=Object.getOwnPropertyDescriptor,g=(e,s,r,a)=>{for(var t=a>1?void 0:a?m(s,r):s,n=e.length-1,i;n>=0;n--)(i=e[n])&&(t=i(t)||t);return t};let p=class extends d{constructor(){super(...arguments),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){const e=performance.memory;if(!e)return o``;const s=(e.usedJSHeapSize/1048576).toFixed(1),r=(e.jsHeapSizeLimit/1048576).toFixed(0),a=e.usedJSHeapSize/e.jsHeapSizeLimit*100,t=a.toFixed(0),n=a>80?"#ff4444":a>60?"#ffaa00":"#44aa44";return o`
        ...
        `}};p=g([c("lyra-memory-usage")],p);u.registerContribution(l,{target:l,label:"Memory",component:"<lyra-memory-usage></lyra-memory-usage>"});
