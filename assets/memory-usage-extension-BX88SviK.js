import{t as c,a as d,b as l,c as m,T as o}from"./main-EmQVFKnb.js";var u=Object.getOwnPropertyDescriptor,g=(e,r,s,a)=>{for(var t=a>1?void 0:a?u(r,s):r,n=e.length-1,i;n>=0;n--)(i=e[n])&&(t=i(t)||t);return t};let p=class extends d{constructor(){super(...arguments),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){const e=performance.memory;if(!e)return l``;const r=(e.totalJSHeapSize/1048576).toFixed(1),s=(e.jsHeapSizeLimit/1048576).toFixed(0),a=e.totalJSHeapSize/e.jsHeapSizeLimit*100,t=a.toFixed(0),n=a>80?"#ff4444":a>60?"#ffaa00":"#44aa44";return l`
