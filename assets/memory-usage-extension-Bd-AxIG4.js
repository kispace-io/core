import{b as c,K as d,x as o,C as m,E as l}from"./main-9sIbE_la.js";var u=Object.getOwnPropertyDescriptor,g=(e,s,i,a)=>{for(var t=a>1?void 0:a?u(s,i):s,n=e.length-1,r;n>=0;n--)(r=e[n])&&(t=r(t)||t);return t};let p=class extends d{constructor(){super(...arguments),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){const e=performance.memory;if(!e)return o``;const s=(e.usedJSHeapSize/1048576).toFixed(1),i=(e.jsHeapSizeLimit/1048576).toFixed(0),a=e.usedJSHeapSize/e.jsHeapSizeLimit*100,t=a.toFixed(0),n=a>80?"#ff4444":a>60?"#ffaa00":"#44aa44";return o`
        ...
        `}};p=g([c("k-memory-usage")],p);m.registerContribution(l,{target:l,label:"Memory",disabled:()=>!performance.memory,html:"<k-memory-usage></k-memory-usage>"});
