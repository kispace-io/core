import{f as c,p as l,t as d,C as m,d as o}from"./config-BIuWNlpk-C_4sybHU.js";var u=Object.getOwnPropertyDescriptor,g=(e,s,r,a)=>{for(var t=a>1?void 0:a?u(s,r):s,n=e.length-1,i;n>=0;n--)(i=e[n])&&(t=i(t)||t);return t};let p=class extends m{constructor(){super(...arguments),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){const e=performance.memory;if(!e)return o``;const s=(e.totalJSHeapSize/1048576).toFixed(1),r=(e.jsHeapSizeLimit/1048576).toFixed(0),a=e.totalJSHeapSize/e.jsHeapSizeLimit*100,t=a.toFixed(0),n=a>80?"#ff4444":a>60?"#ffaa00":"#44aa44";return o`
        ...
        `}};p=g([d("lyra-memory-usage")],p);c.registerContribution(l,{target:l,label:"Memory",component:"<lyra-memory-usage></lyra-memory-usage>"});
