import{K as e,R as t,a as n,j as r,mt as i,p as a}from"./dist-Bk8IQql9.js";var o=class extends n{constructor(...e){super(...e),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){let e=performance.memory;if(!e)return i``;let t=(e.totalJSHeapSize/1048576).toFixed(1),n=(e.jsHeapSizeLimit/1048576).toFixed(0),r=e.totalJSHeapSize/e.jsHeapSizeLimit*100,a=r.toFixed(0);return i`
        ...
        `}};o=r([t(`docks-memory-usage`)],o),e.registerContribution(a,{target:a,label:`Memory`,component:`<docks-memory-usage></docks-memory-usage>`});