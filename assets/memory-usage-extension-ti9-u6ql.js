import{l as c,c as d,q as l}from"./monaco-Dc-M9J7c.js";import{t as m,d as o}from"./vendor-DlX8FWQM.js";var u=Object.getOwnPropertyDescriptor,g=(e,r,s,a)=>{for(var t=a>1?void 0:a?u(r,s):r,n=e.length-1,i;n>=0;n--)(i=e[n])&&(t=i(t)||t);return t};let p=class extends c{constructor(){super(...arguments),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){const e=performance.memory;if(!e)return o``;const r=(e.totalJSHeapSize/1048576).toFixed(1),s=(e.jsHeapSizeLimit/1048576).toFixed(0),a=e.totalJSHeapSize/e.jsHeapSizeLimit*100,t=a.toFixed(0),n=a>80?"#ff4444":a>60?"#ffaa00":"#44aa44";return o`
        ...
        `}};p=g([m("lyra-memory-usage")],p);d.registerContribution(l,{target:l,label:"Memory",component:"<lyra-memory-usage></lyra-memory-usage>"});
