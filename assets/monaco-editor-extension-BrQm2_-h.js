const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/k-monaco-editor-Cl9IWyMj.js","assets/editor.main-Db5P6B9O.js","assets/main-CymV4qDG.js","assets/main-DCTlflHk.css","assets/editor-Dvl_Svmm.css","assets/pyservice-B4T2czJc.js","assets/package-manager-C0F5naej.js"])))=>i.map(i=>d[i]);
import{e as o,b as s,F as c,_ as d,a as i}from"./main-CymV4qDG.js";import{C as r}from"./ai-service-CdoVf8yq.js";import"./in-browser-ml-service-D7AoKjy9.js";const l=`**Python Programming Assistant:**
...
`;o.registerEditorInputHandler({lazyInit:async()=>{await d(()=>import("./k-monaco-editor-Cl9IWyMj.js"),__vite__mapDeps([0,1,2,3,4,5,6]))},canHandle:e=>e instanceof c,handle:async e=>{const n={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return n.widgetFactory=()=>s`
