const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/k-monaco-editor-CW9KeDfH.js","assets/editor.main-N3unysjy.js","assets/main-YFahtWAy.js","assets/main-DCTlflHk.css","assets/editor-Dvl_Svmm.css","assets/pyservice-BPjeJHue.js"])))=>i.map(i=>d[i]);
import{g as o,f as s,e as c,_ as d,m as i,Q as a}from"./main-YFahtWAy.js";const l=`**Python Programming Assistant:**
...
`;o.registerEditorInputHandler({lazyInit:async()=>{await d(()=>import("./k-monaco-editor-CW9KeDfH.js"),__vite__mapDeps([0,1,2,3,4,5]))},canHandle:e=>e instanceof c,handle:async e=>{const n={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return n.widgetFactory=()=>s`
