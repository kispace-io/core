const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/k-monaco-editor-D_dw0XHX.js","assets/editor.main-1i3xujYX.js","assets/main-e2lcKaqt.js","assets/main-BYaEr26l.css","assets/editor-Dvl_Svmm.css","assets/pyservice-BuDWLnEn.js"])))=>i.map(i=>d[i]);
import{f as o,x as s,e as c,_ as d,l as i,Q as r}from"./main-e2lcKaqt.js";const l=`**Python Programming Assistant:**
...
`;o.registerEditorInputHandler({lazyInit:async()=>{await d(()=>import("./k-monaco-editor-D_dw0XHX.js"),__vite__mapDeps([0,1,2,3,4,5]))},canHandle:e=>e instanceof c,handle:async e=>{const n={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return n.widgetFactory=()=>s`
