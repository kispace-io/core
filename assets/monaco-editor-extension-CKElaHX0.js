const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/k-monaco-editor-DO62Rz3r.js","assets/editor.main-B-VwInZX.js","assets/main-DSgoWAaK.js","assets/main-BYaEr26l.css","assets/editor-Dvl_Svmm.css","assets/package-manager-extension-DvVstccy.js"])))=>i.map(i=>d[i]);
import{A as o,x as s,F as c,_ as d,C as i,D as r}from"./main-DSgoWAaK.js";const l=`**Python Programming Assistant:**
...
`;o.registerEditorInputHandler({lazyInit:async()=>{await d(()=>import("./k-monaco-editor-DO62Rz3r.js"),__vite__mapDeps([0,1,2,3,4,5]))},canHandle:e=>e instanceof c,handle:async e=>{const n={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return n.widgetFactory=()=>s`
