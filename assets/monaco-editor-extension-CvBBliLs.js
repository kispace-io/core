const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/k-monaco-editor-B3NrX50b.js","assets/editor.main-DwR2uzn0.js","assets/main-DA3mdgRZ.js","assets/main-DCTlflHk.css","assets/editor-Dvl_Svmm.css","assets/pyservice-C2DFA567.js","assets/package-manager-TwUXNQoD.js"])))=>i.map(i=>d[i]);
import{e as o,b as s,F as c,_ as d,v as i}from"./main-DA3mdgRZ.js";import{C as r}from"./ai-service-Xbmu7sjO.js";import"./in-browser-ml-service-D9cxY0Oa.js";const l=`**Python Programming Assistant:**
...
`;o.registerEditorInputHandler({lazyInit:async()=>{await d(()=>import("./k-monaco-editor-B3NrX50b.js"),__vite__mapDeps([0,1,2,3,4,5,6]))},canHandle:e=>e instanceof c,handle:async e=>{const n={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return n.widgetFactory=()=>s`
