const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/k-monaco-editor-CpUYCult.js","assets/editor.main-v0tJv16h.js","assets/main-CqI8UPkK.js","assets/main-BYaEr26l.css","assets/editor-Dvl_Svmm.css","assets/package-manager-extension-UAcLzdAc.js"])))=>i.map(i=>d[i]);
import{E as o,x as s,F as c,_ as d,H as i,I as r}from"./main-CqI8UPkK.js";const l=`**Python Programming Assistant:**
...
`;o.registerEditorInputHandler({lazyInit:async()=>{await d(()=>import("./k-monaco-editor-CpUYCult.js"),__vite__mapDeps([0,1,2,3,4,5]))},canHandle:e=>e instanceof c,handle:async e=>{const n={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return n.widgetFactory=()=>s`
