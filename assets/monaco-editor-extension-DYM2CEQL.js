const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/k-monaco-editor-2LiUGbYr.js","assets/editor.main-BTROwpuA.js","assets/main-CGzlWBZw.js","assets/main-DCTlflHk.css","assets/editor-Dvl_Svmm.css","assets/pyservice-B1DHeZpS.js","assets/package-manager-3RvZyOGx.js"])))=>i.map(i=>d[i]);
import{e as o,b as s,F as c,_ as d,a as i}from"./main-CGzlWBZw.js";import{C as r}from"./ai-service-C9xFin5A.js";import"./in-browser-ml-service-BMTWZQuo.js";const l=`**Python Programming Assistant:**
...
`;o.registerEditorInputHandler({lazyInit:async()=>{await d(()=>import("./k-monaco-editor-2LiUGbYr.js"),__vite__mapDeps([0,1,2,3,4,5,6]))},canHandle:e=>e instanceof c,handle:async e=>{const n={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return n.widgetFactory=()=>s`
