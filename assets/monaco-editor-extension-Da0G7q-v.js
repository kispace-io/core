const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/k-monaco-editor-B_a0NV2K.js","assets/editor.main-BE9Tz8qP.js","assets/main-D3Vf4nu1.js","assets/main-BYaEr26l.css","assets/editor-Dvl_Svmm.css","assets/package-manager-extension-PG1z7Cmc.js"])))=>i.map(i=>d[i]);
import{A as o,x as s,F as c,_ as d,C as i,D as r}from"./main-D3Vf4nu1.js";const l=`**Python Programming Assistant:**
...
`;o.registerEditorInputHandler({lazyInit:async()=>{await d(()=>import("./k-monaco-editor-B_a0NV2K.js"),__vite__mapDeps([0,1,2,3,4,5]))},canHandle:e=>e instanceof c,handle:async e=>{const n={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return n.widgetFactory=()=>s`
