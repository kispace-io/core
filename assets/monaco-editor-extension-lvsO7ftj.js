const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/k-monaco-editor-CObHH_Dc.js","assets/editor.main-Co17RFl4.js","assets/main-BEYAOB-D.js","assets/main-DCTlflHk.css","assets/editor-Dvl_Svmm.css","assets/pyservice-061Pih5z.js"])))=>i.map(i=>d[i]);
import{e as o,d as s,c,_ as d,h as i,N as a}from"./main-BEYAOB-D.js";const l=`**Python Programming Assistant:**
...
`;o.registerEditorInputHandler({lazyInit:async()=>{await d(()=>import("./k-monaco-editor-CObHH_Dc.js"),__vite__mapDeps([0,1,2,3,4,5]))},canHandle:e=>e instanceof c,handle:async e=>{const n={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return n.widgetFactory=()=>s`
