import{d as e,f as t,p as n}from"./fs-access-D-fDaJ8V-w6cEwJE-.js";import{A as r,B as i,F as a,I as o,J as s,M as c,N as l,R as u,U as d,_t as f,gt as p,j as ee,o as te,z as ne}from"./dist-rtCeiCQp.js";import{t as re}from"./notebook-kernel-api-c9l3_84P-DFy2usuT.js";function m(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var h=m();function ie(e){h=e}var g={exec:()=>null};function _(e,t=``){let n=typeof e==`string`?e:e.source,r={replace:(e,t)=>{let i=typeof t==`string`?t:t.source;return i=i.replace(v.caret,`$1`),n=n.replace(e,i),r},getRegex:()=>new RegExp(n,t)};return r}var ae=(()=>{try{return!0}catch{return!1}})(),v={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,`i`)},oe=/^(?:[ \t]*(?:\n|$))+/,se=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,ce=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,y=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,le=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,b=/(?:[*+-]|\d{1,9}[.)])/,ue=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,x=_(ue).replace(/bull/g,b).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,``).getRegex(),de=_(ue).replace(/bull/g,b).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),S=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,fe=/^[^\n]+/,C=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,pe=_(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace(`label`,C).replace(`title`,/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),me=_(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,b).getRegex(),w=`address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,T=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,he=_(`^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))`,`i`).replace(`comment`,T).replace(`tag`,w).replace(`attribute`,/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),ge=_(S).replace(`hr`,y).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,w).getRegex(),E={blockquote:_(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace(`paragraph`,ge).getRegex(),code:se,def:pe,fences:ce,heading:le,hr:y,html:he,lheading:x,list:me,newline:oe,paragraph:ge,table:g,text:fe},D=_(`^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)`).replace(`hr`,y).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`blockquote`,` {0,3}>`).replace(`code`,`(?: {4}| {0,3}	)[^\\n]`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,w).getRegex(),_e={...E,lheading:de,table:D,paragraph:_(S).replace(`hr`,y).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`table`,D).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)]) `).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,w).getRegex()},ve={...E,html:_(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace(`comment`,T).replace(/tag/g,`(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b`).getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:g,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:_(S).replace(`hr`,y).replace(`heading`,` *#{1,6} *[^
]`).replace(`lheading`,x).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`|fences`,``).replace(`|list`,``).replace(`|html`,``).replace(`|tag`,``).getRegex()},ye=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,be=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,O=/^( {2,}|\\)\n(?!\s*$)/,xe=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,k=/[\p{P}\p{S}]/u,A=/[\s\p{P}\p{S}]/u,j=/[^\s\p{P}\p{S}]/u,Se=_(/^((?![*_])punctSpace)/,`u`).replace(/punctSpace/g,A).getRegex(),M=/(?!~)[\p{P}\p{S}]/u,Ce=/(?!~)[\s\p{P}\p{S}]/u,we=/(?:[^\s\p{P}\p{S}]|~)/u,Te=_(/link|precode-code|html/,`g`).replace(`link`,/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace(`precode-`,ae?"(?<!`)()":"(^^|[^`])").replace(`code`,/(?<b>`+)[^`]+\k<b>(?!`)/).replace(`html`,/<(?! )[^<>]*?>/).getRegex(),N=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Ee=_(N,`u`).replace(/punct/g,k).getRegex(),De=_(N,`u`).replace(/punct/g,M).getRegex(),P=`^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,Oe=_(P,`gu`).replace(/notPunctSpace/g,j).replace(/punctSpace/g,A).replace(/punct/g,k).getRegex(),ke=_(P,`gu`).replace(/notPunctSpace/g,we).replace(/punctSpace/g,Ce).replace(/punct/g,M).getRegex(),Ae=_(`^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)`,`gu`).replace(/notPunctSpace/g,j).replace(/punctSpace/g,A).replace(/punct/g,k).getRegex(),je=_(/\\(punct)/,`gu`).replace(/punct/g,k).getRegex(),Me=_(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace(`scheme`,/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace(`email`,/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Ne=_(T).replace(`(?:-->|$)`,`-->`).getRegex(),Pe=_(`^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>`).replace(`comment`,Ne).replace(`attribute`,/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),F=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Fe=_(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace(`label`,F).replace(`href`,/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace(`title`,/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),I=_(/^!?\[(label)\]\[(ref)\]/).replace(`label`,F).replace(`ref`,C).getRegex(),Ie=_(/^!?\[(ref)\](?:\[\])?/).replace(`ref`,C).getRegex(),Le=_(`reflink|nolink(?!\\()`,`g`).replace(`reflink`,I).replace(`nolink`,Ie).getRegex(),Re=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,L={_backpedal:g,anyPunctuation:je,autolink:Me,blockSkip:Te,br:O,code:be,del:g,emStrongLDelim:Ee,emStrongRDelimAst:Oe,emStrongRDelimUnd:Ae,escape:ye,link:Fe,nolink:Ie,punctuation:Se,reflink:I,reflinkSearch:Le,tag:Pe,text:xe,url:g},ze={...L,link:_(/^!?\[(label)\]\((.*?)\)/).replace(`label`,F).getRegex(),reflink:_(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(`label`,F).getRegex()},R={...L,emStrongRDelimAst:ke,emStrongLDelim:De,url:_(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace(`protocol`,Re).replace(`email`,/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:_(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace(`protocol`,Re).getRegex()},Be={...R,br:_(O).replace(`{2,}`,`*`).getRegex(),text:_(R.text).replace(`\\b_`,`\\b_| {2,}\\n`).replace(/\{2,\}/g,`*`).getRegex()},z={normal:E,gfm:_e,pedantic:ve},B={normal:L,gfm:R,breaks:Be,pedantic:ze},Ve={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},He=e=>Ve[e];function V(e,t){if(t){if(v.escapeTest.test(e))return e.replace(v.escapeReplace,He)}else if(v.escapeTestNoEncode.test(e))return e.replace(v.escapeReplaceNoEncode,He);return e}function Ue(e){try{e=encodeURI(e).replace(v.percentDecode,`%`)}catch{return null}return e}function H(e,t){let n=e.replace(v.findPipe,(e,t,n)=>{let r=!1,i=t;for(;--i>=0&&n[i]===`\\`;)r=!r;return r?`|`:` |`}).split(v.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push(``);for(;r<n.length;r++)n[r]=n[r].trim().replace(v.slashPipe,`|`);return n}function U(e,t,n){let r=e.length;if(r===0)return``;let i=0;for(;i<r;){let a=e.charAt(r-i-1);if(a===t&&!n)i++;else if(a!==t&&n)i++;else break}return e.slice(0,r-i)}function We(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]===`\\`)r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return n>0?-2:-1}function Ge(e,t,n,r,i){let a=t.href,o=t.title||null,s=e[1].replace(i.other.outputLinkReplace,`$1`);r.state.inLink=!0;let c={type:e[0].charAt(0)===`!`?`image`:`link`,raw:n,href:a,title:o,text:s,tokens:r.inlineTokens(s)};return r.state.inLink=!1,c}function Ke(e,t,n){let r=e.match(n.other.indentCodeCompensation);if(r===null)return t;let i=r[1];return t.split(`
`).map(e=>{let t=e.match(n.other.beginningSpace);if(t===null)return e;let[r]=t;return r.length>=i.length?e.slice(i.length):e}).join(`
`)}var W=class{options;rules;lexer;constructor(e){this.options=e||h}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:`space`,raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let e=t[0].replace(this.rules.other.codeRemoveIndent,``);return{type:`code`,raw:t[0],codeBlockStyle:`indented`,text:this.options.pedantic?e:U(e,`
...
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+V(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function Z(e,t){return X.parse(e,t)}Z.options=Z.setOptions=function(e){return X.setOptions(e),Z.defaults=X.defaults,ie(Z.defaults),Z},Z.getDefaults=m,Z.defaults=h,Z.use=function(...e){return X.use(...e),Z.defaults=X.defaults,ie(Z.defaults),Z},Z.walkTokens=function(e,t){return X.walkTokens(e,t)},Z.parseInline=X.parseInline,Z.Parser=J,Z.parser=J.parse,Z.Renderer=K,Z.TextRenderer=q,Z.Lexer=G,Z.lexer=G.lex,Z.Tokenizer=W,Z.Hooks=Y,Z.parse=Z,Z.options,Z.setOptions,Z.use,Z.walkTokens,Z.parseInline,J.parse,G.lex;var Q=n(`NotebookRuntime`),$=class extends te{constructor(...e){super(...e),this.cellOutputs=new Map,this.executingCells=new Set,this.availableKernels=[],this.selectedKernelId=null,this.kernel=null,this.kernelConnected=!1,this.kernelConnecting=!1,this.kernelVersion=void 0,this.editingMarkdownCells=new Set,this.executionCounter=0,this.isRunningAll=!1,this.highlightedCellIndex=-1,this.focusedCellIndex=-1,this.cancelRunAll=!1,this.cellWidgetRefs=new Map,this.cellHeights=new Map}doClose(){this.input=void 0,this.notebook=void 0,this.cellOutputs.clear(),this.executingCells.clear(),this.cellWidgetRefs.clear(),this.cellHeights.clear(),this.focusedCellIndex=-1,this.unsubscribeContributionsToken&&=(t(this.unsubscribeContributionsToken),void 0),this.kernel?.close&&Promise.resolve(this.kernel.close()),this.kernel=null,this.kernelConnected=!1,this.kernelVersion=void 0}async save(){if(!(!this.notebook||!this.input))try{this.saveEditorContents(),this.notebook.cells.forEach((e,t)=>{if(e.cell_type===`code`){let n=this.cellOutputs.get(t);e.outputs=n?this.convertOutputToJupyter(n,e.execution_count):[]}});let e=JSON.stringify(this.notebook,null,2);await this.input.data.saveContents(e),this.markDirty(!1)}catch(e){throw console.error(`Failed to save notebook:`,e),e}}doBeforeUI(){this.loadNotebook()}async onKernelDropdownSelect(e){let t=(e.detail?.item?.value??``)||null;this.selectedKernelId!==t&&(this.kernel?.close&&Promise.resolve(this.kernel.close()),this.kernel=null,this.kernelConnected=!1,this.kernelVersion=void 0,this.selectedKernelId=t,this.notebook&&(this.notebook.metadata||(this.notebook.metadata={}),this.notebook.metadata.kernel=t??void 0),this.cellOutputs.clear(),this.executionCounter=0,this.notebook?.cells?.forEach(e=>{e.cell_type===`code`&&(e.execution_count=null,e.outputs=[])}),this.resetCellState(),await this.ensureKernelLoaded(),this.requestUpdate())}renderToolbar(){let e=this.availableKernels;e.length;let t=this.selectedKernelId?e.find(e=>e.id===this.selectedKernelId)?.label??this.selectedKernelId:`Select kernel`,n=this.kernelConnecting?`Connecting...`:this.kernelConnected?`Kernel connected`:`Kernel disconnected`,r=this.kernelConnecting?`Connecting...`:this.kernelConnected?this.kernelVersion??`Connected`:`Not connected`,i=this.kernelConnected?`var(--wa-color-green-40)`:this.kernelConnecting?`var(--wa-color-warning-500)`:`var(--wa-color-red-40)`,a=this.isRunningAll?p`
        ...
        `;return p`
            ...
            `:``}
            ${this.kernel?.openPackageManager?p`
                <wa-button
                    size="small"
                    appearance="plain"
            ...
            `:``}
            ${this.kernel?this.kernel.connect?p`
                <wa-button
                    appearance="plain"
                    size="small"
                    ...
                    title=${n}
                >
                    <wa-icon name="circle" label="Kernel status" style=${o({color:i})}></wa-icon>
                    ${r}
                </wa-button>
            `:p`
...
`)||`Unknown error`}:null}renderHeaderActions(e,t){return p`
            <div class="cell-header-actions">
                ${t||``}
                ${t?p`<span class="divider"></span>`:``}
        ...
        `}renderFooterActions(e){return p`
...
`);return t.length>0&&(t[t.length-1]=t[t.length-1].replace(/\n$/,``)),t}createCell(e){let t={cell_type:e,source:[``],metadata:{}};return e===`code`&&(t.execution_count=null,t.outputs=[]),t}async executeCell(e){let t=this.notebook.cells[e];if(t.cell_type===`code`){this.executingCells.add(e),this.requestUpdate();try{await this.ensureKernelLoaded();let n=this.kernel;if(!n){this.executingCells.has(e)&&this.cellOutputs.set(e,{type:`error`,data:`No kernel selected`});return}let r=this.getCellWidgetRef(e).value,i=r?r.getContent():this.getCellSource(t);if(i==null)return;let a=await n.execute(i);a.error?this.cellOutputs.set(e,{type:`error`,data:a.error}):this.cellOutputs.set(e,{type:`execute_result`,data:a.data,imageData:a.imageData}),this.executionCounter++,t.execution_count=this.executionCounter,this.markDirty(!0)}catch(t){this.executingCells.has(e)&&this.cellOutputs.set(e,{type:`error`,data:t instanceof Error?t.message:String(t)})}finally{this.executingCells.delete(e),this.requestUpdate()}}}cancelExecution(e){this.kernel?.interrupt?this.kernel.interrupt():(this.cellOutputs.set(e,{type:`error`,data:`Cancellation not supported for this kernel`}),this.executingCells.delete(e),this.requestUpdate())}clearAllOutputs(){this.cellOutputs.clear(),this.executionCounter=0,this.notebook?.cells&&this.notebook.cells.forEach(e=>{e.cell_type===`code`&&(e.execution_count=null,e.outputs=[])}),this.markDirty(!0),this.requestUpdate()}async restartKernel(){if(!(!this.kernel?.restart||this.kernelConnecting))try{this.kernelConnecting=!0,this.requestUpdate(),await this.kernel.restart(),this.kernelConnected=!0,this.kernel.getVersion&&(this.kernelVersion=await this.kernel.getVersion())}catch(e){Q.error(`Failed to restart kernel`,e)}finally{this.kernelConnecting=!1,this.requestUpdate()}}async runAllCells(){if(this.notebook?.cells){this.isRunningAll=!0,this.cancelRunAll=!1,this.requestUpdate();try{for(let e=0;e<this.notebook.cells.length&&!this.cancelRunAll;e++)this.notebook.cells[e].cell_type===`code`&&await this.executeCell(e)}finally{this.isRunningAll=!1,this.cancelRunAll=!1,this.requestUpdate()}}}cancelAllCells(){this.cancelRunAll=!0,this.kernel?.interrupt?.()}toggleMarkdownEdit(e){this.editingMarkdownCells.has(e)?this.editingMarkdownCells.delete(e):this.editingMarkdownCells.add(e),this.requestUpdate()}saveMarkdownEdit(e,t){let n=t.target.value;if(this.notebook&&this.notebook.cells[e]){let t=this.notebook.cells[e],r=this.getCellSource(t);t.source=this.stringToSourceArray(n),r!==n&&this.markDirty(!0)}this.editingMarkdownCells.delete(e),this.requestUpdate()}renderMarkdownCell(e,t){let n=this.getCellSource(e),r=!n||n.trim()===``;if(this.editingMarkdownCells.has(t)){let e=p`
        ...
        `}renderCodeCell(e,t){let n=this.cellOutputs.get(t),r=this.executingCells.has(t),i=this.getCellSource(e),a=this.kernel?.language??`javascript`,s=`${(this.input?.data)?.getWorkspacePath?.()??`notebook`}-cell-${t}`,l=this.cellHeights.get(t)??Math.max(100,i.split(`
`).length*19+10),u=r?p`
            <wa-button 
                size="small" 
                appearance="plain"
                    ...
                    <div class="cell code-cell ${r?`executing`:``}">
                        ...
                        ${n?p`
                            <div class="cell-output ${n.type===`error`?`output-error`:``}">
                                ...
                                `:``}
                                ${n.data?p`<pre><code>${n.data}</code></pre>`:``}
                            </div>
                        `:``}
                        ${this.renderFooterActions(t)}
                    </div>
    ...
    `}};l([ne({attribute:!1})],$.prototype,`input`,void 0),l([u()],$.prototype,`notebook`,void 0),l([u()],$.prototype,`cellOutputs`,void 0),l([u()],$.prototype,`executingCells`,void 0),l([u()],$.prototype,`availableKernels`,void 0),l([u()],$.prototype,`selectedKernelId`,void 0),l([u()],$.prototype,`kernel`,void 0),l([u()],$.prototype,`kernelConnected`,void 0),l([u()],$.prototype,`kernelConnecting`,void 0),l([u()],$.prototype,`kernelVersion`,void 0),l([u()],$.prototype,`editingMarkdownCells`,void 0),l([u()],$.prototype,`executionCounter`,void 0),l([u()],$.prototype,`isRunningAll`,void 0),l([u()],$.prototype,`highlightedCellIndex`,void 0),l([u()],$.prototype,`cellHeights`,void 0),$=l([i(`docks-notebook-editor`)],$);export{$ as DocksNotebookEditor};