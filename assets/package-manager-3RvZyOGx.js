import{k as d,i as m,n as p,r as l,u as h,b as i,j as k,v as u,t as f}from"./main-CGzlWBZw.js";var v=Object.defineProperty,y=Object.getOwnPropertyDescriptor,r=(a,e,o,s)=>{for(var n=s>1?void 0:s?y(e,o):e,c=a.length-1,g;c>=0;c--)(g=a[c])&&(n=(s?g(e,o,n):g(n))||n);return s&&n&&v(e,o,n),n};let t=class extends h{constructor(){super(...arguments),this.open=!1,this.packages=[],this.loadingPackages=!1}configure(a){this.packages=a.packages||[],this.pyenv=a.pyenv,this.onPackageAdded=a.onPackageAdded,this.onPackageRemoved=a.onPackageRemoved}show(){this.open=!0}hide(){this.open=!1}addPackage(a){if(!a||a.trim()==="")return;const e=a.trim();this.packages.includes(e)||(this.packages=[...this.packages,e],this.onPackageAdded?.(e))}removePackage(a){this.packages.indexOf(a)>-1&&(this.packages=this.packages.filter(o=>o!==a),this.onPackageRemoved?.(a))}async reloadPackages(){if(this.pyenv){this.loadingPackages=!0,this.packageLoadError=void 0;try{await this.pyenv.loadPackages(this.packages)}catch(a){this.packageLoadError=String(a)}finally{this.loadingPackages=!1}}}render(){let a;return i`
    ...
    `;r([p({type:Boolean})],t.prototype,"open",2);r([p({type:Array})],t.prototype,"packages",2);r([p({attribute:!1})],t.prototype,"pyenv",2);r([l()],t.prototype,"loadingPackages",2);r([l()],t.prototype,"packageLoadError",2);t=r([f("k-python-package-manager")],t);class w{showPackageManager(e){return this.managerInstance||(this.managerInstance=document.createElement("k-python-package-manager"),document.body.appendChild(this.managerInstance)),this.managerInstance.configure(e),this.managerInstance.show(),this.managerInstance}getManager(){return this.managerInstance}}const P=new w,x=a=>{d.put("pythonPackageManagerService",P)};export{P as p,x as r};
