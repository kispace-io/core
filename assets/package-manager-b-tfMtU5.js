import{b as d,n as g,e as l,a as m,d as i,k as h,m as k,t as u}from"./vendor-DlX8FWQM.js";import{v as f}from"./monaco-DsELU3gt.js";var y=Object.defineProperty,v=Object.getOwnPropertyDescriptor,r=(a,e,o,s)=>{for(var n=s>1?void 0:s?v(e,o):e,c=a.length-1,p;c>=0;c--)(p=a[c])&&(n=(s?p(e,o,n):p(n))||n);return s&&n&&y(e,o,n),n};let t=class extends m{constructor(){super(...arguments),this.open=!1,this.packages=[],this.loadingPackages=!1}configure(a){this.packages=a.packages||[],this.pyenv=a.pyenv,this.onPackageAdded=a.onPackageAdded,this.onPackageRemoved=a.onPackageRemoved}show(){this.open=!0}hide(){this.open=!1}addPackage(a){if(!a||a.trim()==="")return;const e=a.trim();this.packages.includes(e)||(this.packages=[...this.packages,e],this.onPackageAdded?.(e))}removePackage(a){this.packages.indexOf(a)>-1&&(this.packages=this.packages.filter(o=>o!==a),this.onPackageRemoved?.(a))}async reloadPackages(){if(this.pyenv){this.loadingPackages=!0,this.packageLoadError=void 0;try{await this.pyenv.loadPackages(this.packages)}catch(a){this.packageLoadError=String(a)}finally{this.loadingPackages=!1}}}render(){let a;return i`
    ...
    `;r([g({type:Boolean})],t.prototype,"open",2);r([g({type:Array})],t.prototype,"packages",2);r([g({attribute:!1})],t.prototype,"pyenv",2);r([l()],t.prototype,"loadingPackages",2);r([l()],t.prototype,"packageLoadError",2);t=r([u("lyra-python-package-manager")],t);class w{showPackageManager(e){return this.managerInstance||(this.managerInstance=document.createElement("lyra-python-package-manager"),document.body.appendChild(this.managerInstance)),this.managerInstance.configure(e),this.managerInstance.show(),this.managerInstance}getManager(){return this.managerInstance}}const P=new w;f.put("pythonPackageManagerService",P);export{P as p};
