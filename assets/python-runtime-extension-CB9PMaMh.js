const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/python-editor-B1mouJ5J.js","assets/vendor-DlX8FWQM.js","assets/vendor-CTYeukuQ.css","assets/monaco-Dc-M9J7c.js","assets/monaco-Dvl_Svmm.css","assets/pyservice-DQOt8A6K.js","assets/package-manager-D95grhdR.js","assets/pglite-Czu7YiMR.js"])))=>i.map(i=>d[i]);
import{d as h,_ as y}from"./vendor-DlX8FWQM.js";import{w as g,c as u,r as l,t as f,j as m,F as v}from"./monaco-Dc-M9J7c.js";import{T as P}from"./pglite-Czu7YiMR.js";import{P as s}from"./pyservice-DQOt8A6K.js";import{p as c}from"./package-manager-D95grhdR.js";class _{constructor(){this.id="python",this.label="Python",this.language="python",this.pyenv=null,this.requiredPackages=[]}async connect(t){if(this.pyenv)return;this.requiredPackages=t?.requiredPackages??[],this.pyenv=new s;const e=await g.getWorkspace();await this.pyenv.init(e),this.requiredPackages.length>0&&await this.pyenv.loadPackages(this.requiredPackages);try{await this.pyenv.execCode(`
try:
    import matplotlib
    matplotlib.use('agg')
