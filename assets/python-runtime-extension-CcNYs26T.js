const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/python-editor-evI9wDzi.js","assets/vendor-BGO3_IMz.js","assets/vendor-CTYeukuQ.css","assets/monaco-CTMlGF8K.js","assets/monaco-Dvl_Svmm.css","assets/pyservice-mYLi-E6y.js","assets/package-manager-6JZAvkdg.js","assets/pglite-D6gOiCgb.js"])))=>i.map(i=>d[i]);
import{d as y,_ as h}from"./vendor-BGO3_IMz.js";import{w as g,c as u,r as l,t as f,j as m,F as v}from"./monaco-CTMlGF8K.js";import{T as _}from"./pglite-D6gOiCgb.js";import{P as r}from"./pyservice-mYLi-E6y.js";import{p as c}from"./package-manager-6JZAvkdg.js";class P{constructor(){this.id="python",this.label="Python",this.language="python",this.pyenv=null,this.requiredPackages=[]}async connect(t){if(this.pyenv)return;this.requiredPackages=t?.requiredPackages??[],this.pyenv=new r;const e=await g.getWorkspace();await this.pyenv.init(e),this.requiredPackages.length>0&&await this.pyenv.loadPackages(this.requiredPackages);try{await this.pyenv.execCode(`
try:
    import matplotlib
    matplotlib.use('agg')
