const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/python-editor-CxfpnKiw.js","assets/vendor-DlX8FWQM.js","assets/vendor-CTYeukuQ.css","assets/monaco-BbC9iOIH.js","assets/monaco-Dvl_Svmm.css","assets/pyservice-fcxNjcN-.js","assets/package-manager-T1rGz1m-.js","assets/pglite-BfCfFp1F.js"])))=>i.map(i=>d[i]);
import{d as h,_ as y}from"./vendor-DlX8FWQM.js";import{w as g,c as u,r as l,t as f,j as m,H as v}from"./monaco-BbC9iOIH.js";import{T as P}from"./pglite-BfCfFp1F.js";import{P as s}from"./pyservice-fcxNjcN-.js";import{p as c}from"./package-manager-T1rGz1m-.js";class _{constructor(){this.id="python",this.label="Python",this.language="python",this.pyenv=null,this.requiredPackages=[]}async connect(t){if(this.pyenv)return;this.requiredPackages=t?.requiredPackages??[],this.pyenv=new s;const e=await g.getWorkspace();await this.pyenv.init(e),this.requiredPackages.length>0&&await this.pyenv.loadPackages(this.requiredPackages);try{await this.pyenv.execCode(`
try:
    import matplotlib
    matplotlib.use('agg')
