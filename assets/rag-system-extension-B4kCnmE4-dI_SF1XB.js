const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-rJDCxO7C.js","assets/config-BIuWNlpk-C_4sybHU.js","assets/config-BIuWNlpk-Cw9IDlk8.css","assets/index-BJpRdiQX.js","assets/plugin-DTC-2ba9.js","assets/rx-query-helper-BrSngD3C.js","assets/broadcast-channel-D4yYrDWZ.js","assets/rx-query-BLha2BXq.js","assets/tslib.es6-D3hF0DQN.js","assets/rx-storage-multiinstance-DKXSEllp.js","assets/index-CCKQYxju.js","assets/index-DqShJrlj.js","assets/index-C0tneMXB.js","assets/index-CBfuaIwJ.js","assets/rag-integration-DADxKKrU-BUGW9eZL.js","assets/ai-service-CHv1hGx1-D7BtNrJ2.js","assets/in-browser-ml-service-BkNRK5pS-B6ZVm7EJ.js"])))=>i.map(i=>d[i]);
import{D as ae,a1 as we,a0 as xe,ad as ye,W as E,ae as ve,w as V,af as $e,Z as C,_ as z,s as be,k as O,R as F,y,A as R,ac as k,q as ee,d as x,T as ke,f as De,b as Se,n as Ee,r as P,L as Ce,J as Te,B as X,K as Pe,t as Ie}from"./config-BIuWNlpk-C_4sybHU.js";import{a as Ne,i as Ae,M as Re}from"./in-browser-ml-service-BkNRK5pS-B6ZVm7EJ.js";import{c as Oe}from"./ai-service-CHv1hGx1-D7BtNrJ2.js";const W=C("EmbeddingService");class ze{constructor(){this.modelName=Ne.FEATURE_EXTRACTION,this.EMBEDDING_DIMENSION=384,this.DEFAULT_OPTIONS={pooling:"mean",normalize:!0}}async initialize(){if(this.pipePromise)try{await this.pipePromise;return}catch{W.warn("Previous initialization failed, retrying..."),this.pipePromise=void 0}W.info(`Initializing embedding service with model: ${this.modelName}`);try{this.pipePromise=Ae.getPipeline(Re.FEATURE_EXTRACTION,this.modelName,{quantized:!1}),await this.pipePromise,W.info("Embedding service initialized successfully")}catch(e){const t=e?.message||String(e),a=e?JSON.stringify(e):"";throw W.error(`Failed to initialize embedding service: ${t}${a?` - ${a}`:""}`),this.pipePromise=void 0,new Error(`Embedding service initialization failed: ${t}`)}}async generateEmbedding(e,t={}){this.pipePromise||await this.initialize();const a=await this.pipePromise,n={...this.DEFAULT_OPTIONS,...t};try{const i=await a(e,{pooling:n.pooling,normalize:n.normalize}),s=Array.from(i.data);return s.length!==this.EMBEDDING_DIMENSION&&W.warn(`Unexpected embedding dimension: ${s.length}, expected ${this.EMBEDDING_DIMENSION}`),s}catch(i){throw W.error(`Failed to generate embedding: ${i}`),i}}async generateEmbeddings(e,t={}){const a=[];for(const n of e){const i=await this.generateEmbedding(n,t);a.push(i)}return a}getEmbeddingDimension(){return this.EMBEDDING_DIMENSION}getModelName(){return this.modelName}}const G=new ze,_={PREVIEW:500,CONTEXT:150},L={FILE_NAME_MATCH:10,FILE_PATH_MATCH:5,CONTENT_MATCH:1,FILE_NAME_EXACT:20,FILE_PATH_EXACT:10,EXACT_PHRASE:5,TERM_COVERAGE:15},Q={DEFAULT_LIMIT:5,MAX_LIMIT:20},_e={SAMPLE_VECTOR_COUNT:5},B=["idx0","idx1","idx2","idx3","idx4"],Fe={LONG:1e3};function Le(o,e){if(o.length!==e.length)throw new Error(`Vector dimensions must match: ${o.length} vs ${e.length}`);let t=0;for(let a=0;a<o.length;a++){const n=o[a]-e[a];t+=n*n}return Math.sqrt(t)}function Me(o,e,t){const a=[];if(t&&t.length>0)for(let n=0;n<o;n++)if(n<t.length)a.push({vector:t[n],idx:n});else{const i=[];for(let s=0;s<e;s++)i.push(Math.random()*2-1);a.push({vector:i,idx:n})}else for(let n=0;n<o;n++){const i=[];for(let s=0;s<e;s++)i.push(Math.random()*2-1);a.push({vector:i,idx:n})}return a}function ie(o,e){if(e.length!==B.length)throw new Error(`Sample vectors count (${e.length}) must match index field count (${B.length})`);const t={};for(let a=0;a<B.length;a++)t[B[a]]=Le(o,e[a].vector);return t}function We(o,e){if(o.length!==e.length)throw new Error(`Vector dimensions must match: ${o.length} vs ${e.length}`);let t=0,a=0,n=0;for(let s=0;s<o.length;s++)t+=o[s]*e[s],a+=o[s]*o[s],n+=e[s]*e[s];const i=Math.sqrt(a)*Math.sqrt(n);return i===0?0:t/i}const Ve=500,Ge=50,Ue=100;class se{constructor(e={}){this.chunkSize=e.chunkSize??Ve,this.chunkOverlap=e.chunkOverlap??Ge,this.minChunkSize=e.minChunkSize??Ue}chunkDocument(e,t,a){if(t.length<=this.chunkSize){const r=`${a} ${t}`;return[{id:`${e}:chunk:0`,documentId:e,chunkIndex:0,text:r,startOffset:0,endOffset:t.length}]}const n=[],i=this.chunkSize-this.chunkOverlap;let s=0,c=0;for(;s<t.length;){const r=Math.min(s+this.chunkSize,t.length),l=t.substring(s,r);if(l.trim().length<this.minChunkSize&&n.length>0)break;const d=c===0?`${a} ${l}`:l;n.push({id:`${e}:chunk:${c}`,documentId:e,chunkIndex:c,text:d,startOffset:s,endOffset:r}),s+=i,c++}return n}getChunkContext(e,t){const a=e.chunkIndex>0?t[e.chunkIndex-1]:null,n=e.chunkIndex<t.length-1?t[e.chunkIndex+1]:null;let i="";return a&&(i+=`[Previous: ${a.text.substring(Math.max(0,a.text.length-_.CONTEXT))}]

`),i+=e.text,n&&(i+=`

[Next: ${n.text.substring(0,_.CONTEXT)}]`),i}}const K=C("LangChainChunker"),je=500,Be=75;function He(o){return!o||o.trim().length===0?0:o.trim().split(/\s+/).filter(e=>e.length>0).length}class qe{constructor(e={}){this.textSplitter=null,this.chunkSize=e.chunkSize??je,this.chunkOverlap=e.chunkOverlap??Be}async getTextSplitter(){if(!this.textSplitter){const{RecursiveCharacterTextSplitter:e}=await z(async()=>{const{RecursiveCharacterTextSplitter:t}=await import("./index-rJDCxO7C.js");return{RecursiveCharacterTextSplitter:t}},__vite__mapDeps([0,1,2]));this.textSplitter=new e({chunkSize:this.chunkSize,chunkOverlap:this.chunkOverlap,lengthFunction:He,separators:[`
...
Use the information from these documents to provide a helpful answer. Pay special attention to numbers, percentages, dates, and specific values mentioned in the snippets. If the documents don't contain relevant information, you can still answer based on your general knowledge.`}formatSearchResults(e){return e.map(t=>({file:t.document.fileName,path:t.document.filePath,relevance:t.relevance.toFixed(2),language:t.document.metadata.language,size:t.document.metadata.size,snippets:t.matchedSnippets,preview:this.snippetExtractor.extractSimpleSnippet(t.document.content,200)+"..."}))}formatCommandResults(e){return e.map(t=>({file:t.document.fileName,path:t.document.filePath,relevance:t.relevance,snippets:t.matchedSnippets}))}}const A=C("RAGService"),T=new te,it=new at(T);class st{async searchDocuments(e,t={}){const a=Math.min(t.limit||Q.DEFAULT_LIMIT,Q.MAX_LIMIT),n=await q(t.workspacePath);if(!n)return A.warn("No workspace connected, cannot search documents"),[];const{workspacePath:i}=n;if(t.filePath){const s=await v.getDocumentByPath(i,t.filePath);if(s){const c=H(e),r=c.length>0?T.extractSnippets(s.content,c,3):[T.extractSimpleSnippet(s.content,_.PREVIEW)];return[{document:s,relevance:100,matchedSnippets:r}]}return A.warn(`Document not found: ${t.filePath}`),[]}if(t.fileName){const s=await v.listDocuments(i),c=t.fileName.toLowerCase(),r=s.filter(l=>{const d=l.fileName.toLowerCase();return d===c||d.includes(c)});if(r.length>0){const l=[],d=H(e);for(const m of r.slice(0,a)){const g=d.length>0?T.extractSnippets(m.content,d,3):[T.extractSimpleSnippet(m.content,_.PREVIEW)];l.push({document:m,relevance:ue.calculateFileNameRelevance(m,t.fileName),matchedSnippets:g})}return l}return A.warn(`No documents found with name: ${t.fileName}`),[]}if(!e||!e.trim())return A.warn("No query provided and no filePath/fileName specified"),[];try{const s=await v.searchSimilar(e,{limit:a*2,workspacePath:i,fileType:t.fileType}),c=[];for(const{document:r,similarity:l,chunkStartOffset:d,chunkEndOffset:m}of s){if(!this.matchesContextScope(r,t.documentSearchScope))continue;const g=l*100;if(t.minRelevance&&g<t.minRelevance)continue;const p=fe(e),u=H(e);let w;if(d!==void 0&&m!==void 0){const f=r.content.substring(Math.max(0,d),Math.min(r.content.length,m));f.trim().length>0?w=[f.trim()]:w=T.extractSnippets(r.content,u,15)}else w=T.extractSnippets(r.content,u,15);if(w.length===0&&p.length>0)if(d!==void 0&&m!==void 0){const f=r.content.substring(Math.max(0,d),Math.min(r.content.length,m));f.trim().length>0?w=[f.trim()]:w=T.extractSnippets(r.content,[p],10)}else w=T.extractSnippets(r.content,[p],10);if(c.push({document:r,relevance:g,matchedSnippets:w}),c.length>=a)break}return c.length===0?(A.debug("Vector search returned no results, falling back to text search"),this.fallbackTextSearch(e,t)):c}catch(s){return A.warn(`Vector search failed, falling back to text search: ${s}`),A.debug(`Vector search error details: ${s}`),this.fallbackTextSearch(e,t)}}async fallbackTextSearch(e,t={}){const a=Math.min(t.limit||Q.DEFAULT_LIMIT,Q.MAX_LIMIT),n=await q(t.workspacePath);if(!n)return A.warn("No workspace connected, cannot perform text search"),[];const{workspacePath:i}=n,s=await v.listDocuments(i),c=H(e),r=[];for(const l of s){if(t.fileType&&l.fileType!==t.fileType||!this.matchesContextScope(l,t.documentSearchScope))continue;const d=ue.calculateRelevance(l,e);if(t.minRelevance&&d<t.minRelevance)continue;const m=T.extractSnippets(l.content,c,3);r.push({document:l,relevance:d,matchedSnippets:m})}return r.sort((l,d)=>d.relevance-l.relevance),r.slice(0,a)}formatRAGContext(e){return it.formatRAGContext(e)}matchesContextScope(e,t){if(!t)return!0;if(t.includePaths&&t.includePaths.length>0&&!t.includePaths.some(n=>n.includes("*")||n.includes("?")?new RegExp("^"+n.replace(/\*/g,".*").replace(/\?/g,".")+"$").test(e.filePath):e.filePath.startsWith(n)||e.filePath===n)||t.excludePaths&&t.excludePaths.length>0&&t.excludePaths.some(n=>n.includes("*")||n.includes("?")?new RegExp("^"+n.replace(/\*/g,".*").replace(/\?/g,".")+"$").test(e.filePath):e.filePath.startsWith(n)||e.filePath===n)||t.pathPattern&&!(t.pathPattern instanceof RegExp?t.pathPattern:new RegExp(t.pathPattern)).test(e.filePath))return!1;if(t.tags&&t.tags.length>0){const a=e.metadata.tags||[];if(!t.tags.every(i=>a.includes(i)))return!1}return!(t.metadataFilter&&!t.metadataFilter(e))}}const rt=new st;async function ot(o,e={}){const t=await q(e.workspacePath);return t?rt.searchDocuments(o,{...e,workspacePath:t.workspacePath}):(A.warn("No workspace connected, cannot search documents"),[])}var ct=Object.defineProperty,lt=Object.getOwnPropertyDescriptor,D=(o,e,t,a)=>{for(var n=a>1?void 0:a?lt(e,t):e,i=o.length-1,s;i>=0;i--)(s=o[i])&&(n=(a?s(e,t,n):s(n))||n);return a&&n&&ct(e,t,n),n};const j=C("RAGSystemManager"),me=new te;let b=class extends Ce{constructor(){super(...arguments),this.documents=[],this.stats={totalDocuments:0,byWorkspace:{}},this.loading=!1,this.selectedDocument=null,this.searchQuery="",this.filterWorkspace=null,this.filterByActiveWorkspace=!0,this.filteredDocuments=[],this.searchResults=new Map,this.reindexing=!1,this.treeRef=Te(),this.searchInputValue=""}async doInitUI(){try{await v.initialize(),await Promise.all([this.loadDocuments(),this.loadStats()])}catch(o){j.error(`Failed to initialize document index manager: ${o}`),y(`Failed to initialize: ${o}`)}}async loadDocuments(){this.loading=!0,this.requestUpdate();try{let o;this.filterByActiveWorkspace&&(o=(await q())?.workspacePath),this.documents=await v.listDocuments(o),await this.updateFilteredDocuments()}catch(o){j.error(`Failed to load documents: ${o}`),y(`Failed to load documents: ${o}`)}finally{this.loading=!1}}async updateFilteredDocuments(){this.filteredDocuments=await this.getFilteredDocuments(),this.requestUpdate()}async loadStats(){try{this.stats=await v.getStats(),this.requestUpdate()}catch(o){j.error(`Failed to load stats: ${o}`)}}handleTreeSelection(o){let e=o.detail?.selection||[];if(e.length===0&&this.treeRef.value&&(e=this.treeRef.value.selectedItems||[]),e.length>0){const t=e[0];t?.model?this.selectedDocument=t.model:this.selectedDocument=null}else this.selectedDocument=null}async getFilteredDocuments(){if(!this.documents||this.documents.length===0)return[];if(this.searchQuery.trim())try{const e=await ot(this.searchQuery,{limit:50,workspacePath:this.filterWorkspace||void 0});this.searchResults.clear();const t=new Map,a=new Map;for(const i of e){const s=i.document.id;t.set(s,i.document);const c=a.get(s);if(!c)a.set(s,{document:i.document,relevance:i.relevance,matchedSnippets:[...i.matchedSnippets]});else{i.relevance>c.relevance&&(c.relevance=i.relevance);const r=new Set(c.matchedSnippets);for(const l of i.matchedSnippets)r.has(l)||(c.matchedSnippets.push(l),r.add(l))}}for(const[i,s]of a)this.searchResults.set(i,s);const n=Array.from(t.values());return this.filterWorkspace?n.filter(i=>i.workspacePath===this.filterWorkspace):n}catch(e){return j.debug(`RAG search failed in document manager: ${e}`),this.searchResults.clear(),[]}else this.searchResults.clear();let o=[...this.documents];return this.filterWorkspace&&(o=o.filter(e=>e.workspacePath===this.filterWorkspace)),o}highlightMatches(o,e){if(!e||!e.trim())return x`${o}`;const t=e.toLowerCase(),a=o.toLowerCase(),n=[];let i=0,s=a.indexOf(t,i);for(;s!==-1;)s>i&&n.push(o.substring(i,s)),n.push(x`<mark class="search-match">${o.substring(s,s+e.length)}</mark>`),i=s+e.length,s=a.indexOf(t,i);return i<o.length&&n.push(o.substring(i)),x`${n}`}getContentPreview(o){const e=this.searchResults.get(o.id);if(e&&e.matchedSnippets.length>0)return x`
            ...
            `;if(this.searchQuery&&this.searchQuery.trim()){const a=me.extractContextSnippets(o.content,this.searchQuery,_.CONTEXT);if(a.length>0)return x`
                    <table class="snippets-table">
                        <thead>
                            <tr>
                                <th class="snippet-number-col">#</th>
                ...
                `}const t=me.extractSimpleSnippet(o.content,Fe.LONG);return x`
            <div class="snippet-preview">${t}</div>
        `}async deleteDocument(o){try{await v.deleteDocument(o.id),k(`Deleted: ${o.fileName}`),await this.loadDocuments(),await this.loadStats(),this.selectedDocument?.id===o.id&&(this.selectedDocument=null)}catch(e){y(`Failed to delete document: ${e}`)}}async reindexDocument(o){try{const e=await q();if(!e){y("No workspace connected");return}const t=await e.workspace.getResource(o.filePath);if(!t){y(`File not found: ${o.filePath}`);return}if(!(t instanceof E)){y(`Resource is not a file: ${o.filePath}`);return}const a=t;await R.runAsync("Reindexing document",async n=>{n.message=`Reindexing ${o.fileName}...`,await v.reindexDocument(a),n.progress=100}),k(`Reindexed: ${o.fileName}`),await this.loadDocuments(),this.selectedDocument?.id===o.id&&(this.selectedDocument=await v.getDocument(o.id))}catch(e){y(`Failed to reindex document: ${e}`)}}async reindexAllDocuments(){if(this.reindexing)return;const o=await v.getStats();if(o.totalDocuments===0){k("No documents to reindex");return}this.reindexing=!0,this.requestUpdate();try{const e=await R.runAsync("Reindexing all documents",async t=>{t.message="Starting reindexing...";const a=o.totalDocuments,n=await v.reindexAllDocuments(),i=n.succeeded+n.failed;return t.progress=a>0?i/a*100:100,t.message=`Reindexed ${n.succeeded}/${a} documents${n.failed>0?` (${n.failed} failed)`:""}`,n});await this.loadDocuments(),await this.loadStats(),k(`Reindexing completed: ${e.succeeded} succeeded, ${e.failed} failed`)}catch(e){j.error(`Failed to reindex all documents: ${e}`),y(`Failed to reindex all documents: ${e}`)}finally{this.reindexing=!1,this.requestUpdate()}}formatFileSize(o){return o<1024?`${o} B`:o<1024*1024?`${(o/1024).toFixed(1)} LyraB`:`${(o/(1024*1024)).toFixed(1)} MB`}formatDate(o){return new Date(o).toLocaleString()}getFileIcon(o){return ee.getFileIcon(o)}renderToolbar(){const o=Object.keys(this.stats?.byWorkspace||{});return x`
            <wa-input
                type="search"
