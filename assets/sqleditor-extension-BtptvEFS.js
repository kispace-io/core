import{v as L,k as f,t as p,L as T,s as S,z as q,c as k,m as v,A as O,x as R,a as x,j as A,H as z}from"./monaco-BbC9iOIH.js";import{b as C,n as g,e as c,a as U,d as l,m as _,t as I,j as P,k as M}from"./vendor-DlX8FWQM.js";var Q=Object.defineProperty,B=Object.getOwnPropertyDescriptor,b=(e,t,n,a)=>{for(var i=a>1?void 0:a?B(t,n):t,o=e.length-1,s;o>=0;o--)(s=e[o])&&(i=(a?s(t,n,i):s(i))||i);return a&&i&&Q(t,n,i),i};let d=class extends U{constructor(){super(...arguments),this.open=!1,this.db=null,this.databaseLabel="",this.extensions=[],this.loading=!1,this.updatingId=null,this.error=null,this.filterText=""}configure(e){this.db=e.db,this.databaseLabel=e.databaseLabel,this.extensions=[],this.error=null,this.refreshExtensions()}show(){!this.db||!this.db.listDbExtensions||(this.open=!0)}hide(){this.open=!1}async refreshExtensions(){if(!this.db||!this.db.listDbExtensions){this.extensions=[];return}this.loading=!0,this.error=null;try{const e=await f.runAsync("Loading database extensions",async()=>this.db.listDbExtensions());this.extensions=Array.isArray(e)?e:[]}catch(e){const t=e instanceof Error?e.message:String(e);this.error=t,p(t)}finally{this.loading=!1}}async enableExtension(e){if(!(!this.db||!this.db.enableDbExtension)){this.updatingId=e.id,this.error=null;try{await f.runAsync(`Enabling extension ${e.label||e.id}`,async()=>this.db.enableDbExtension(e.id)),await this.refreshExtensions()}catch(t){const n=t instanceof Error?t.message:String(t);this.error=n,p(n)}finally{this.updatingId=null}}}async disableExtension(e){if(!(!this.db||!this.db.disableDbExtension)){this.updatingId=e.id,this.error=null;try{await f.runAsync(`Disabling extension ${e.label||e.id}`,async()=>this.db.disableDbExtension(e.id)),await this.refreshExtensions()}catch(t){const n=t instanceof Error?t.message:String(t);this.error=n,p(n)}finally{this.updatingId=null}}}renderExtensionRow(e){const t=!!e.installed,n=t&&!!this.db?.disableDbExtension,a=this.updatingId===e.id;return l`
      ...
      >
        <div class="extension-manager">
          ...
          <div class="extension-list">
            ${this.loading?l`<div class="extension-list-empty">Loading extensions…</div>`:a?_(n,i=>i.id,i=>this.renderExtensionRow(i)):l`
  ...
  `;u([g({attribute:!1})],r.prototype,"input",2);u([g({type:Boolean})],r.prototype,"readOnly",2);u([c()],r.prototype,"initialContent",2);u([c()],r.prototype,"initialUri",2);u([c()],r.prototype,"running",2);u([c()],r.prototype,"availableAdapters",2);u([c()],r.prototype,"selectedEngineId",2);u([c()],r.prototype,"availableConnections",2);u([c()],r.prototype,"selectedConnectionId",2);r=u([I("lyra-sql-editor")],r);function X(){A.registerEditorInputHandler({editorId:"system.sqleditor",label:"SQL Editor",icon:"database",canHandle:e=>e instanceof z&&e.getName().toLowerCase().endsWith(".sql"),ranking:900,handle:async e=>{const t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:"database",noOverflow:!1,state:{},component:()=>null};return t.component=()=>l`<lyra-sql-editor .input=${t}></lyra-sql-editor>`,t}})}export{X as default};
