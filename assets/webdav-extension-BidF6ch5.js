import{Y as S,x as u,w as c,J as h,H as E,X as N,Z as V,I as v,r as F,_ as T,c as O}from"./monaco-BbC9iOIH.js";import{e as y,t as $,d as b}from"./vendor-DlX8FWQM.js";class D{constructor(e){if(this.baseUrl=e.url,e.username!==void 0){const t=`${e.username}:${e.password??""}`;this.authHeader=`Basic ${btoa(t)}`}}async propfind(e,t=1){const o=await fetch(new URL(e,this.baseUrl).href,{method:"PROPFIND",headers:this.buildHeaders({Depth:t.toString(),"Content-Type":"application/xml"}),body:`<?xml version="1.0" encoding="UTF-8"?>
        ...
        `}};f([y()],p.prototype,"url",2);f([y()],p.prototype,"username",2);f([y()],p.prototype,"password",2);f([y()],p.prototype,"connecting",2);f([y()],p.prototype,"showHelp",2);p=f([$("lyra-webdav-connect")],p);const m=v("WebDAV");F({command:{id:"workspace.connect.webdav",name:"WebDAV / NextCloud",description:"Connect to WebDAV servers, Nextcloud shares, ownCloud, and other cloud storage",parameters:[{name:"url",type:"string",description:"WebDAV URL: share link (https://cloud.example.com/s/TOKEN) or direct endpoint",required:!1},{name:"password",type:"string",description:"Password (if required)",required:!1}]},handler:{execute:async r=>{const e=r.parameters?.url,t=r.parameters?.password;if(!e){await T.open("webdav-connect-dialog");return}try{let s;const o=e.match(/^(https?:\/\/[^\/]+)\/(?:index\.php\/)?s\/([A-Za-z0-9]+)/);if(o){const a=o[1],n=o[2];s={url:`${a}/public.php/webdav/`,username:n,password:t||""}}else s={url:e,...t&&{username:"",password:t}};await c.connectWorkspace(s),m.info("Connected to WebDAV workspace")}catch(s){s instanceof Error?m.error(`Failed to connect: ${s.message}`):m.error("Failed to connect to WebDAV workspace")}}},contribution:{target:"filebrowser.connections",name:"filebrowser.connections.webdav",label:"WebDAV / NextCloud",icon:"cloud"}});const I=v("WebDAVExtension");c.registerContribution({type:"webdav",name:"webdav",canHandle(r){return r&&typeof r=="object"&&"url"in r&&typeof r.url=="string"},async connect(r){const e=new D(r),t={href:r.url,displayName:W(r.url),isDirectory:!0};return new d(e,t,void 0,r)},async restore(r){if(!(!r||!r.url))try{const e={url:r.url,username:r.username,password:r.password?B(r.password):void 0},t=new D(e),s={href:r.url,displayName:W(r.url),isDirectory:!0};return new d(t,s,void 0,e)}catch(e){I.error("Failed to restore WebDAV workspace:",e);return}},async persist(r){if(r instanceof d){const e=r.getConnectionInfo();return e?{url:e.url,...e.username!==void 0?{username:e.username}:{},...e.password!==void 0?{password:M(e.password)}:{}}:null}return null}});O.registerContribution("dialogs",{label:"Connect to WebDAV / NextCloud",icon:"cloud",name:"dialog.webdav.connect",id:"webdav-connect-dialog",buttons:[{id:"help",label:"Show help",variant:"neutral"},{id:"cancel",label:"Cancel",variant:"default"},{id:"connect",label:"Connect",variant:"primary"}],component:r=>b`<lyra-webdav-connect></lyra-webdav-connect>`,onButton:async(r,e,t)=>{const s=e;return r==="help"?(s?.toggleHelp(),!1):r==="connect"?s?.handleConnect?await s.handleConnect()?(t?.close?.(),!0):!1:!0:(r==="cancel"&&t?.close?.(),!0)}});function W(r){try{const t=new URL(r).pathname.split("/").filter(Boolean);return t[t.length-1]||"workspace"}catch{return"workspace"}}function M(r){try{const t=new TextEncoder().encode(r);let s="";for(const o of t)s+=String.fromCharCode(o);return btoa(s)}catch{return r}}function B(r){try{const e=atob(r),t=new Uint8Array(e.length);for(let o=0;o<e.length;o++)t[o]=e.charCodeAt(o);return new TextDecoder().decode(t)}catch{return r}}export{D as WebDAVClient,d as WebDAVDirectoryResource,U as WebDAVFileResource};
