import{a as e,l as t,n,p as r,r as i,t as a,u as o}from"./fs-access-D-fDaJ8V-BUpCKyMj.js";import{I as s,J as c,K as l,R as u,S as d,i as f,j as p,mt as m}from"./dist-D_mTL68B.js";var h=class{constructor(e){if(this.baseUrl=e.url,e.username!==void 0){let t=`${e.username}:${e.password??``}`;this.authHeader=`Basic ${btoa(t)}`}}async propfind(e,t=1){let n=await fetch(new URL(e,this.baseUrl).href,{method:`PROPFIND`,headers:this.buildHeaders({Depth:t.toString(),"Content-Type":`application/xml`}),body:`<?xml version="1.0" encoding="UTF-8"?>
