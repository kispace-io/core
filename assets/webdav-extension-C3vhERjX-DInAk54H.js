import{a as e,l as t,n,p as r,r as i,t as a,u as o}from"./fs-access-DEIaNyms-RyMkFh5Y.js";import{I as s,J as c,K as l,R as u,S as d,a as f,j as p,mt as m}from"./dist-BW9tMLZU.js";var h=class{constructor(e){if(this.baseUrl=e.url,e.username!==void 0){let t=`${e.username}:${e.password??``}`;this.authHeader=`Basic ${btoa(t)}`}}async propfind(e,t=1){let n=await fetch(new URL(e,this.baseUrl).href,{method:`PROPFIND`,headers:this.buildHeaders({Depth:t.toString(),"Content-Type":`application/xml`}),body:`<?xml version="1.0" encoding="UTF-8"?>
        ...
        `}};p([s()],y.prototype,`url`,void 0),p([s()],y.prototype,`username`,void 0),p([s()],y.prototype,`password`,void 0),p([s()],y.prototype,`connecting`,void 0),p([s()],y.prototype,`showHelp`,void 0),y=p([u(`lyra-webdav-connect`)],y);var b=r(`WebDAV`);c({command:{id:`workspace.connect.webdav`,name:`WebDAV / NextCloud`,description:`Connect to WebDAV servers, Nextcloud shares, ownCloud, and other cloud storage`,parameters:[{name:`url`,type:`string`,description:`WebDAV URL: share link (https://cloud.example.com/s/TOKEN) or direct endpoint`,required:!1},{name:`password`,type:`string`,description:`Password (if required)`,required:!1}]},handler:{execute:async e=>{let n=e.parameters?.url,r=e.parameters?.password;if(!n){await d.open(`webdav-connect-dialog`);return}try{let e,i=n.match(/^(https?:\/\/[^\/]+)\/(?:index\.php\/)?s\/([A-Za-z0-9]+)/);if(i){let t=i[1],n=i[2];e={url:`${t}/public.php/webdav/`,username:n,password:r||``}}else e={url:n,...r&&{username:``,password:r}};await t.connectWorkspace(e),b.info(`Connected to WebDAV workspace`)}catch(e){e instanceof Error?b.error(`Failed to connect: ${e.message}`):b.error(`Failed to connect to WebDAV workspace`)}}},contribution:{target:`filebrowser.connections`,name:`filebrowser.connections.webdav`,label:`WebDAV / NextCloud`,icon:`cloud`}});var x=r(`WebDAVExtension`);t.registerContribution({type:`webdav`,name:`webdav`,canHandle(e){return e&&typeof e==`object`&&`url`in e&&typeof e.url==`string`},async connect(e){return new _(new h(e),{href:e.url,displayName:S(e.url),isDirectory:!0},void 0,e)},async restore(e){if(!(!e||!e.url))try{let t={url:e.url,username:e.username,password:e.password?w(e.password):void 0};return new _(new h(t),{href:e.url,displayName:S(e.url),isDirectory:!0},void 0,t)}catch(e){x.error(`Failed to restore WebDAV workspace:`,e);return}},async persist(e){if(e instanceof _){let t=e.getConnectionInfo();return t?{url:t.url,...t.username===void 0?{}:{username:t.username},...t.password===void 0?{}:{password:C(t.password)}}:null}return null}}),l.registerContribution(`dialogs`,{label:`Connect to WebDAV / NextCloud`,icon:`cloud`,name:`dialog.webdav.connect`,id:`webdav-connect-dialog`,buttons:[{id:`help`,label:`Show help`,variant:`neutral`},{id:`cancel`,label:`Cancel`,variant:`default`},{id:`connect`,label:`Connect`,variant:`primary`}],component:e=>m`<lyra-webdav-connect></lyra-webdav-connect>`,onButton:async(e,t,n)=>{let r=t;return e===`help`?(r?.toggleHelp(),!1):e===`connect`?r?.handleConnect?await r.handleConnect()?(n?.close?.(),!0):!1:!0:(e===`cancel`&&n?.close?.(),!0)}});function S(e){try{let t=new URL(e).pathname.split(`/`).filter(Boolean);return t[t.length-1]||`workspace`}catch{return`workspace`}}function C(e){try{let t=new TextEncoder().encode(e),n=``;for(let e of t)n+=String.fromCharCode(e);return btoa(n)}catch{return e}}function w(e){try{let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return new TextDecoder().decode(n)}catch{return e}}export{h as WebDAVClient,_ as WebDAVDirectoryResource,g as WebDAVFileResource};